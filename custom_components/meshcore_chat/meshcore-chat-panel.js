...
`,fe=/^<[^>]+>\s*/,be=/@\[([^\]]+)\]/g,ye=/@(\w+)/g,_e={recipient_type_entity:"select.meshcore_recipient_type",channel_entity:"select.meshcore_channel",contact_entity:"select.meshcore_contact",channel_entity_pattern:"binary_sensor.meshcore_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.meshcore_{prefix}_{contact}_messages",domain_filter:"meshcore"},xe={..._e,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"relative",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function we(e,t){try{const i={type:"meshcore_chat/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch{return[]}}async function $e(e,t){try{const i={type:"meshcore_chat/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch{return[]}}async function ke(e,t){try{const i={type:"meshcore_chat/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch{throw new Error("Failed to get device configuration")}}async function Ce(e,t,i){try{const o={type:"meshcore_chat/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1,changed:[]}}}async function Se(e,t,i,o){try{const r={type:"meshcore_chat/execute_local",command:t};return i&&(r.args=i),o&&(r.entry_id=o),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function Me(e,t,i,o){try{const r={type:"meshcore_chat/execute_remote",target_prefix:t,command:i};return o&&(r.entry_id=o),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function ze(e,t,i,o){try{const r={type:"meshcore_chat/add_contact",public_key:t};return i&&(r.name=i),o&&(r.entry_id=o),await e.callWS(r)}catch{return{success:!1}}}async function Ae(e,t,i){try{const o={type:"meshcore_chat/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1}}}const De=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function Oe(e){const t=[],i=new Set;let o;const r=new RegExp(be.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const a=new RegExp(ye.source,"g");for(;null!==(o=a.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function Ie(e){return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:Oe(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count}}function Te(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function Ee(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=Math.floor((i.getTime()-o.getTime())/864e5);return 0===r?"Today":1===r?"Yesterday":r<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class Re{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"meshcore_chat/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(Ie);this._hasOlderMessages=i.has_more;const r=new Set(this._messages.map(e=>e.id)),a=o.filter(e=>!r.has(e.id));a.length>0&&(this._messages=[...a,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch{}finally{this._loadingOlder=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{const t=50,i=await this._hass.callWS({type:"meshcore_chat/get_stored_messages",entity_id:e,limit:t}),o=i.messages.map(Ie);this._hasOlderMessages=i.has_more;const r=new Set(o.map(e=>e.id)),a=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=o.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...o,...a],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const s=this._config.max_messages??500;this._messages.length>s&&(this._messages=this._messages.slice(-s),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"meshcore_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"meshcore_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){const t=e.sender_name??e.sender,i=e.message??e.text;if(t===this._config.node_name){if(t&&i){const o=e.ack_received,r=e.repeater_count,a=e.rx_log_data,s=e.message_type;let n;n="dm"===s||"direct"===s?{status:!0===o?"delivered":"sent",ackReceived:o??void 0}:{status:"sent",repeaterCount:r??a?.length??0};for(let e=this._messages.length-1;e>=0;e--){const o=this._messages[e];if(o.id.startsWith("optimistic_")&&o.sender===t&&o.text===i){o.deliveryStatus=n,a&&(o.rxLogData=a),this._notify();break}}}this._entityId&&this._debouncedFetch(this._entityId)}else{if(t&&i){let o=i.replace(fe,"");const r=t+": ";o.startsWith(r)&&(o=o.substring(r.length));const a=e.timestamp||(new Date).toISOString(),s=new Date(a),n=function(e,t,i){return function(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,r=i+9+63&-64,a=new Uint8Array(r);a.set(t),a[i]=128;const s=new DataView(a.buffer);s.setUint32(r-4,o,!1);let n=1779033703,d=3144134277,c=1013904242,l=2773480762,p=1359893119,h=2600822924,u=528734635,g=1541459225;const m=new Int32Array(64);for(let e=0;e<r;e+=64){for(let t=0;t<16;t++)m[t]=s.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(m[e-15]>>>7|m[e-15]<<25)^(m[e-15]>>>18|m[e-15]<<14)^m[e-15]>>>3,i=(m[e-2]>>>17|m[e-2]<<15)^(m[e-2]>>>19|m[e-2]<<13)^m[e-2]>>>10;m[e]=m[e-16]+t+m[e-7]+i|0}let t=n,i=d,o=c,r=l,a=p,v=h,f=u,b=g;for(let e=0;e<64;e++){const s=b+((a>>>6|a<<26)^(a>>>11|a<<21)^(a>>>25|a<<7))+(a&v^~a&f)+De[e]+m[e]|0,n=t&i^t&o^i&o;b=f,f=v,v=a,a=r+s|0,r=o,o=i,i=t,t=s+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,d=d+i|0,c=c+o|0,l=l+r|0,p=p+a|0,h=h+v|0,u=u+f|0,g=g+b|0}const v=e=>(e>>>0).toString(16).padStart(8,"0");return v(n)+v(d)+v(c)+v(l)+v(p)+v(h)+v(u)+v(g)}(`${e}|${t}|${i}`).substring(0,12)}(a,t,o),d=`rt_${n}`,c=this._messages.some(e=>e.id===d||e.id===n);if(!c){const r=Oe(o),a=e.rx_log_data,n={id:d,sender:t,text:o,timestamp:s,isOutgoing:!1,isSystem:!1,raw:i,mentions:r,rxLogData:a&&a.length>0?a:void 0};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._notify()}}this._entityId&&this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch{}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,r=e.timestamp;if(i&&o){const e=r?new Date(r).getTime():0;for(let r=this._messages.length-1;r>=0;r--){const a=this._messages[r];if(!a.isOutgoing&&a.sender===i&&a.text===o&&(!e||Math.abs(a.timestamp.getTime()-e)<1e4))return a.rxLogData=t,a.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,r=e.repeater_count,a=e.ack_received,s=e.round_trip_ms,n=e.progressive;if(!i)return;let d,c;d=o||(!0===a?"delivered":!n||void 0!==r&&0!==r?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){c=this._messages[e];break}c&&(c.deliveryStatus={status:d,repeaterCount:r,ackReceived:a,roundTripMs:s},void 0!==r&&(c.repeaterCount=r),this._notify())}async _pollFetch(e){if(this._hass)try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"meshcore_chat/get_stored_messages",entity_id:e,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i);if(0===o.messages.length)return this._error=null,void(this._retryCount=0);const r=o.messages.map(Ie),a=new Set(this._messages.map(e=>e.id)),s=r.filter(e=>!a.has(e.id));if(s.length>0){const e=new Set(s.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!s.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=this._config.max_messages??500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch{this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch{}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let Ne=class extends ce{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.searchQuery="",this.unreadCounts={},this._activeFilter="all",this._filteredConversations=[]}updated(e){(e.has("conversations")||e.has("searchQuery")||e.has("_activeFilter"))&&this._updateFiltered()}render(){const e=this.searchQuery.length>0;return j`
  ...
  `,e([ge({type:Array})],Ne.prototype,"conversations",void 0),e([ge({type:String})],Ne.prototype,"activeId",void 0),e([ge({type:String})],Ne.prototype,"searchQuery",void 0),e([ge({type:Object})],Ne.prototype,"unreadCounts",void 0),e([me()],Ne.prototype,"_activeFilter",void 0),e([me()],Ne.prototype,"_filteredConversations",void 0),Ne=e([pe("meshcore-conversation-list")],Ne);let Fe=class extends ce{constructor(){super(...arguments),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._saving=!1,this._error=null,this._initialized=!1}willUpdate(e){e.has("open")&&this.open&&!this._initialized&&(this.editMode?(this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName):this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0,this._initialized=!0),e.has("open")&&!this.open&&(this._initialized=!1)}render(){if(!this.open)return;const e=this._customKey.length,t=64===e||0===e||this._autoKey;return j`
    ...
    `],e([ge({type:Boolean})],Fe.prototype,"open",void 0),e([ge({type:Object})],Fe.prototype,"hass",void 0),e([ge({type:String})],Fe.prototype,"entryId",void 0),e([ge({type:Boolean})],Fe.prototype,"narrow",void 0),e([ge({type:Boolean})],Fe.prototype,"editMode",void 0),e([ge({type:Number})],Fe.prototype,"initialChannelIdx",void 0),e([ge({type:String})],Fe.prototype,"initialChannelName",void 0),e([ge({type:Array})],Fe.prototype,"availableIndices",void 0),e([me()],Fe.prototype,"_channelIdx",void 0),e([me()],Fe.prototype,"_channelName",void 0),e([me()],Fe.prototype,"_customKey",void 0),e([me()],Fe.prototype,"_autoKey",void 0),e([me()],Fe.prototype,"_saving",void 0),e([me()],Fe.prototype,"_error",void 0),Fe=e([pe("meshcore-channel-dialog")],Fe);let Le=class extends ce{constructor(){super(...arguments),this.narrow=!1,this._activeTab="contacts",this._contacts=[],this._channels=[],this._searchQuery="",this._loading=!1,this._actionInProgress=null,this._confirmingRemoveContact=null,this._confirmingRemoveChannel=null,this._channelDialogOpen=!1,this._editingChannel=null,this._maxChannels=4}connectedCallback(){super.connectedCallback(),this._loadData()}render(){return j`
  ...
  `,e([ge({type:Object})],Le.prototype,"hass",void 0),e([ge({type:String})],Le.prototype,"entryId",void 0),e([ge({type:Boolean})],Le.prototype,"narrow",void 0),e([me()],Le.prototype,"_activeTab",void 0),e([me()],Le.prototype,"_contacts",void 0),e([me()],Le.prototype,"_channels",void 0),e([me()],Le.prototype,"_searchQuery",void 0),e([me()],Le.prototype,"_loading",void 0),e([me()],Le.prototype,"_actionInProgress",void 0),e([me()],Le.prototype,"_confirmingRemoveContact",void 0),e([me()],Le.prototype,"_confirmingRemoveChannel",void 0),e([me()],Le.prototype,"_channelDialogOpen",void 0),e([me()],Le.prototype,"_editingChannel",void 0),e([me()],Le.prototype,"_maxChannels",void 0),Le=e([pe("meshcore-manage-dialog")],Le);const qe=e=>(...t)=>({_$litDirective$:e,values:t});class Pe{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}class Be extends Pe{constructor(e){if(super(e),this.it=G,2!==e.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===G||null==e)return this._t=void 0,this.it=e;if(e===U)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Be.directiveName="unsafeHTML",Be.resultType=1;const He=qe(Be);let Ve=class extends ce{constructor(){super(...arguments),this.timestampFormat="relative",this._selectedMessage=null}render(){return this.group?j`
        ${this._renderGroup()}
  ...
  `,e([ge({type:Object})],Ve.prototype,"group",void 0),e([ge({type:Object})],Ve.prototype,"message",void 0),e([ge({type:String})],Ve.prototype,"timestampFormat",void 0),e([me()],Ve.prototype,"_selectedMessage",void 0),Ve=e([pe("meshcore-message-bubble")],Ve);let je=class extends ce{constructor(){super(...arguments),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null}render(){return j`
  ...
  `,e([ge({type:Object})],Ke.prototype,"hass",void 0),e([ge({type:Object})],Ke.prototype,"config",void 0),e([ge({type:Array})],Ke.prototype,"conversations",void 0),e([ge({type:String})],Ke.prototype,"selectedId",void 0),e([ge({type:Boolean})],Ke.prototype,"narrow",void 0),e([ge({type:Object})],Ke.prototype,"unreadCounts",void 0),e([me()],Ke.prototype,"_messageStore",void 0),e([me()],Ke.prototype,"_inputText",void 0),e([me()],Ke.prototype,"_sending",void 0),e([me()],Ke.prototype,"_viewportNarrow",void 0),e([me()],Ke.prototype,"_narrowShowMessages",void 0),e([me()],Ke.prototype,"_manageOpen",void 0),e([me()],Ke.prototype,"_searchOpen",void 0),e([me()],Ke.prototype,"_currentEntityId",void 0),e([me()],Ke.prototype,"_conversationResolved",void 0),e([me()],Ke.prototype,"_pendingScroll",void 0),Ke=e([pe("meshcore-chat-page")],Ke);const Ue=qe(class extends Pe{constructor(e){if(super(e),this._timer=null,this._startX=0,this._startY=0,this._attached=!1,this._callback=null,this._element=null,this._onPointerDown=e=>this._handleDown(e),this._onPointerUp=()=>this._cancelTimer(),this._onPointerMove=e=>this._handleMove(e),this._onContextMenu=e=>{null!==this._timer&&e.preventDefault()},6!==e.type)throw new Error("longPress directive must be used on an element")}render(e){}update(e,[t]){if(this._callback=t,!this._attached){this._element=e.element;const t=this._element;t.addEventListener("pointerdown",this._onPointerDown),t.addEventListener("pointerup",this._onPointerUp),t.addEventListener("pointercancel",this._onPointerUp),t.addEventListener("pointermove",this._onPointerMove),t.addEventListener("contextmenu",this._onContextMenu),this._attached=!0}return this.render(t)}_handleDown(e){0===e.button&&(this._startX=e.clientX,this._startY=e.clientY,this._cancelTimer(),this._timer=setTimeout(()=>{this._timer=null,this._callback?.()},500))}_handleMove(e){if(null===this._timer)return;const t=e.clientX-this._startX,i=e.clientY-this._startY;t*t+i*i>100&&this._cancelTimer()}_cancelTimer(){null!==this._timer&&(clearTimeout(this._timer),this._timer=null)}});let Ge=class extends ce{constructor(){super(...arguments),this.entityId="",this.label="",this.icon="",this.colorScheme="neutral"}render(){if(!this.hass||!this.entityId)return G;const e=this.hass.states[this.entityId];if(!e)return G;const t=e.state,i=e.attributes?.unit_of_measurement||"",o=this.label||e.attributes?.friendly_name||this.entityId,r="unavailable"===t||"unknown"===t,a=this.hass.entities?.[this.entityId]?.display_precision;let s="";if("battery"===this.colorScheme){const e=parseFloat(t);isNaN(e)||(s=e>50?"battery-high":e>20?"battery-medium":"battery-low")}else"signal"===this.colorScheme&&(s="signal");return j`
  ...
  `,e([ge({type:Number})],Qe.prototype,"value",void 0),e([ge({type:Number})],Qe.prototype,"min",void 0),e([ge({type:Number})],Qe.prototype,"max",void 0),e([ge({type:String})],Qe.prototype,"band",void 0),Qe=e([pe("meshcore-stat-bar")],Qe);let Je=class extends ce{constructor(){super(...arguments),this.segments=[],this.legend="below"}_denom(){if(void 0!==this.total&&this.total>0)return this.total;const e=this.segments.reduce((e,t)=>e+(Number.isFinite(t.value)?t.value:0),0);return e>0?e:1}render(){if(!this.segments.length)return G;const e=this._denom();return j`
      <div class="stat-bar"
           role="img"
  ...
  `,e([ge({type:Array})],Je.prototype,"segments",void 0),e([ge({type:Number})],Je.prototype,"total",void 0),e([ge({type:String})],Je.prototype,"legend",void 0),Je=e([pe("meshcore-stacked-bar")],Je);let Ze=class extends ce{constructor(){super(...arguments),this.content="",this.glyph="ⓘ"}render(){return this.content?j`
    ...
    `:G}_stopPropagation(e){e.stopPropagation()}};Ze.styles=s`
    :host {
      display: inline-flex;
  ...
  `,e([ge({type:String})],Ze.prototype,"content",void 0),e([ge({type:String})],Ze.prototype,"source",void 0),e([ge({type:String})],Ze.prototype,"glyph",void 0),Ze=e([pe("meshcore-info-tip")],Ze);let et=class extends ce{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0}render(){if(!this.hass||!this.device)return G;const e=this._buildGroups();return j`
      <div class="hero-row">
    ...
    `}_renderHeroTiles(){const e=this.device;return"companion"===e.type?this._renderCompanionHero():"repeater"===e.type?this._renderRepeaterHero():this._renderClientHero()}_renderRepeaterHero(){return j`
      ${this._renderBatteryTile()}
      ${this._renderSignalTile()}
      ${this._renderRadioActivityTile()}
      ${this._renderLocationTile()}
    `}_renderClientHero(){return j`
      ${this._renderBatteryTile()}
      ${this._renderSignalTile()}
      ${this._renderLocationTile()}
    ...
    `}_renderBatteryTile(){const e=this._findByMetric("battery_pct");if(!e)return G;const t=this._readNumber(e.entity_id),i=this._findEntityIdMatching("battery_voltage")??this._findEntityByLabel("Voltage"),o=i?this._readNumber(i.entity_id):NaN,r=Ye("battery_pct",t);return j`
    ...
    `}_renderSignalTile(){const e=this._findByMetric("rssi");if(!e)return G;const t=this._readNumber(e.entity_id),i=this._findByMetric("snr"),o=i?this._readNumber(i.entity_id):NaN,r=Ye("rssi",t);return j`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(e.entity_id)}>
        <div class="hero-tile-head">
    ...
    `}_renderRadioActivityTile(){const e=this._findByMetric("tx_airtime_util"),t=this._findByMetric("rx_airtime_util");if(!e&&!t)return G;const i=e?this._readNumber(e.entity_id):0,o=t?this._readNumber(t.entity_id):0,r=Number.isFinite(i)?Math.max(0,i):0,a=Number.isFinite(o)?Math.max(0,o):0,s=Math.max(0,100-r-a),n=Ye("tx_airtime_util",r).band,d=Ye("rx_airtime_util",a).band,c=this._worseBand(n,d),l=[{value:r,label:`TX ${r.toFixed(1)}%`,kind:"tx"},{value:a,label:`RX ${a.toFixed(1)}%`,kind:"rx"},{value:s,label:`Idle ${s.toFixed(1)}%`,kind:"idle"}];return j`
      <div class="hero-tile"
        ...
        <div class="hero-tile-value">
          <span class="compact">
            TX ${r.toFixed(1)}% · RX ${a.toFixed(1)}% · Idle ${s.toFixed(1)}%
          </span>
        </div>
    ...
    `}_renderLocationTile(){const e=this._findEntityIdMatching("latitude"),t=this._findEntityIdMatching("longitude"),i=e?this._readNumber(e.entity_id):NaN,o=t?this._readNumber(t.entity_id):NaN,r=Number.isFinite(i)&&Number.isFinite(o)&&(0!==i||0!==o);return j`
      <div class="hero-tile"
           @click=${()=>e&&this._fireMoreInfo(e.entity_id)}>
        <div class="hero-tile-head">
          <span>Location</span>
    ...
    `}_buildGroups(){const e={"Radio · live":[],"Radio · configuration":[],"Traffic · totals":[],Status:[],Identity:[]},t=new Set,i=this._buildTrafficRows(t);i.length&&e["Traffic · totals"].push(...i);const o=this._buildRadioCompositeRows(t);o.length&&e["Radio · live"].push(...o);for(const i of this.entities)t.has(i.entity_id)||this._isHeroDuplicate(i)||e[this._groupOf(i)].push(this._renderRow(i));return Object.entries(e).filter(([,e])=>e.length>0).map(([e,t])=>({name:e,rows:t}))}_isHeroDuplicate(e){return"battery_pct"===e.metricKey||!!e.entity_id.includes("battery_voltage")||"snr"===e.metricKey||"rssi"===e.metricKey||"uptime_hours"===e.metricKey}_groupOf(e){const t=e.entity_id,i=e.sortOrder;return 2===i?"Status":6===i?"Radio · configuration":4===i||5===i||9===i||10===i||11===i||12===i||t.includes("noise_floor")||t.includes("tx_queue")?"Radio · live":t.includes("frequency")||t.includes("bandwidth")||t.includes("spreading_factor")||t.includes("rate_limiter")?"Radio · configuration":t.includes("hop_count")||t.includes("out_path")||t.includes("last_seen")||t.includes("last_advert")||3===i||8===i||7===i?"Status":"Identity"}_renderGroup(e){return j`
      <tr class="group-row"><td colspan="4">${e.name}</td></tr>
      ${e.rows}
    `}_renderRow(e){const t=this._readNumber(e.entity_id),i=this.hass?.states[e.entity_id],o=i?.attributes?.unit_of_measurement??"",r=e.metricKey?this._evaluateForRow(e.metricKey,t,e):null,a=r?.band??"info",s=this._formatRowValue(e,t,i?.state);return j`
      <tr class="data-row"
          @click=${()=>this._fireMoreInfo(e.entity_id)}
          @contextmenu=${t=>this._fireContextMenu(t,e)}
          ${Ue(()=>this._fireContextMenu(void 0,e))}>
        <td class="col-status">
          <span class="status-dot ${a}"></span>
        </td>
        <td class="col-label">
          ${e.label}
          ${r?this._renderInfoTip(r):G}
        </td>
        <td class="col-value">
          ${s}${o?j`<span class="unit">${o}</span>`:G}
        </td>
        <td class="col-bar">
    ...
    `}_evaluateForRow(e,t,i){if("uptime_hours"===e){let o=t;switch(this.hass?.states[i.entity_id]?.attributes?.unit_of_measurement??""){case"d":o=24*t;break;case"h":o=t;break;case"min":o=t/60;break;default:o=t/3600}return Ye(e,o)}return Ye(e,t)}_buildRadioCompositeRows(e){const t=[],i=this._findEntityByLabel("Airtime"),o=this._findEntityByLabel("RX Airtime"),r=this._findByMetric("uptime_hours");if((i||o)&&r){const a=i?this._timeValueInSeconds(i.entity_id):0,s=o?this._timeValueInSeconds(o.entity_id):0,n=this._timeValueInSeconds(r.entity_id);if(Number.isFinite(n)&&n>0){const r=Math.max(0,a/n*100),d=Math.max(0,s/n*100),c=Math.max(0,100-r-d),l=[{value:r,label:`TX ${r.toFixed(2)}%`,kind:"tx"},{value:d,label:`RX ${d.toFixed(2)}%`,kind:"rx"},{value:c,label:`Idle ${c.toFixed(1)}%`,kind:"idle"}],p=this._worseBand(Ye("tx_airtime_util",r).band,Ye("rx_airtime_util",d).band);t.push(j`
          <tr class="data-row stacked-row"
              @click=${()=>i&&this._fireMoreInfo(i.entity_id)}>
            <td class="col-status">
              <span class="status-dot ${p}"></span>
            </td>
            <td class="col-label">
              Airtime
              ${this._renderInfoTip({band:p,fillPct:0,tooltip:"Cumulative TX and RX airtime as a percentage of total uptime. Bar represents 100% of uptime; segments are TX, RX, and idle."})}
            </td>
            <td class="col-value">${(r+d).toFixed(2)}%</td>
            <td class="col-bar">
              <meshcore-stacked-bar
                .segments=${l}
                .total=${100}
        ...
        `),i&&e.add(i.entity_id),o&&e.add(o.entity_id)}}const a=this._findByMetric("tx_airtime_util"),s=this._findByMetric("rx_airtime_util");if(a||s){const i=a?this._readNumber(a.entity_id):NaN,o=s?this._readNumber(s.entity_id):NaN,r=Number.isFinite(i)?Math.max(0,i):0,n=Number.isFinite(o)?Math.max(0,o):0,d=Math.max(0,100-r-n),c=[{value:r,label:`TX ${r.toFixed(1)}%`,kind:"tx"},{value:n,label:`RX ${n.toFixed(1)}%`,kind:"rx"},{value:d,label:`Idle ${d.toFixed(1)}%`,kind:"idle"}],l=this._worseBand(Ye("tx_airtime_util",r).band,Ye("rx_airtime_util",n).band);t.push(j`
        <tr class="data-row stacked-row"
            @click=${()=>a&&this._fireMoreInfo(a.entity_id)}>
          <td class="col-status">
            <span class="status-dot ${l}"></span>
          </td>
          <td class="col-label">
            Airtime utilization
            ${this._renderInfoTip({band:l,fillPct:0,tooltip:"Windowed TX and RX airtime utilization over the last reporting interval. Bar segments sum to ≤ 100%; idle fills the rest."})}
          </td>
          <td class="col-value">${(r+n).toFixed(1)}%</td>
          <td class="col-bar">
            <meshcore-stacked-bar
              .segments=${c}
              .total=${100}
      ...
      `),a&&e.add(a.entity_id),s&&e.add(s.entity_id)}return t}_timeValueInSeconds(e){const t=this._readNumber(e);if(!Number.isFinite(t))return NaN;switch(this.hass?.states[e]?.attributes?.unit_of_measurement??"s"){case"d":return 86400*t;case"h":return 3600*t;case"min":return 60*t;default:return t}}_readDerivedRate(e,t){const i=e.replace(`_${t}_`,`_${t}_rate_`);if(!this.hass?.states[i])return NaN;const o=this.hass.states[i].state;if("unavailable"===o||"unknown"===o)return NaN;const r=parseFloat(o);return Number.isFinite(r)?r:NaN}_buildTrafficRows(e){const t=[],i=this._findEntityIdMatching("nb_sent"),o=this._findEntityIdMatching("sent_flood"),r=this._findEntityIdMatching("sent_direct");if(i&&(o||r)){const a=this._readNumber(i.entity_id),s=o?this._readNumber(o.entity_id):0,n=r?this._readNumber(r.entity_id):0,d=Math.max(0,a-s-n),c=[{value:s,label:`Flood ${s}`,kind:"flood"},{value:n,label:`Direct ${n}`,kind:"direct"},{value:d,label:`Other ${d}`,kind:"other"}],l=this._readDerivedRate(i.entity_id,"nb_sent");t.push(this._renderTrafficRow("Messages sent",a,c,Number.isFinite(l)?`${l.toFixed(1)} msg/min`:void 0)),[i,o,r].forEach(t=>t&&e.add(t.entity_id))}const a=this._findEntityIdMatching("nb_recv"),s=this._findEntityIdMatching("recv_flood"),n=this._findEntityIdMatching("recv_direct"),d=this._findEntityIdMatching("flood_dups"),c=this._findEntityIdMatching("direct_dups");if(a&&(s||n)){const i=this._readNumber(a.entity_id),o=s?this._readNumber(s.entity_id):0,r=n?this._readNumber(n.entity_id):0,l=Math.max(0,i-o-r),p=[{value:o,label:`Flood ${o}`,kind:"flood"},{value:r,label:`Direct ${r}`,kind:"direct"},{value:l,label:`Other ${l}`,kind:"other"}],h=d?this._readNumber(d.entity_id):0,u=c?this._readNumber(c.entity_id):0,g=(Number.isFinite(h)?h:0)+(Number.isFinite(u)?u:0),m=i>0?g/i*100:0,v=Ye("duplicate_ratio",m).band,f=this._readDerivedRate(a.entity_id,"nb_recv"),b=Number.isFinite(f)?`${f.toFixed(1)} msg/min`:void 0;t.push(j`
        <tr class="data-row stacked-row"
            @click=${()=>this._fireMoreInfo(a.entity_id)}>
          <td class="col-status">
            <span class="status-dot info"></span>
          </td>
          <td class="col-label">Messages received</td>
          <td class="col-value">${i}</td>
          <td class="col-bar">
            <meshcore-stacked-bar
              .segments=${p}
              .legend=${"inline"}>
            </meshcore-stacked-bar>
            ${b?j`<div class="rate-annotation">${b}</div>`:G}
            ${g>0?j`<div class="dup-annotation">
                  + <span class="num" style="color: var(--${v})">
                    ${g}
                  </span> duplicate${1===g?"":"s"}
                  (${m.toFixed(1)}% of recv)
                </div>`:G}
          </td>
        </tr>
      `),[a,s,n,d,c].forEach(t=>t&&e.add(t.entity_id))}const l=this._findEntityIdMatching("request_succ"),p=this._findEntityIdMatching("request_fail");if(l&&p){const i=this._readNumber(l.entity_id),o=this._readNumber(p.entity_id),r=i+o,a=r>0?i/r*100:0,s=r>=50?Ye("request_success_rate",a):{band:"info",fillPct:0,tooltip:"Insufficient samples (< 50 attempts)."},n=[{value:i,label:`${i} ok`,kind:"success"},{value:o,label:`${o} fail`,kind:"failure"}];t.push(j`
        <tr class="data-row stacked-row"
            @click=${()=>this._fireMoreInfo(l.entity_id)}>
          <td class="col-status">
            <span class="status-dot ${s.band}"></span>
          </td>
          <td class="col-label">
            Requests
            ${this._renderInfoTip(s)}
          </td>
          <td class="col-value">
            ${r>0?`${a.toFixed(0)}%`:"—"}
          </td>
      ...
      `),e.add(l.entity_id),e.add(p.entity_id)}return t}_renderTrafficRow(e,t,i,o){return j`
      <tr class="data-row stacked-row">
        <td class="col-status">
          <span class="status-dot info"></span>
        </td>
        <td class="col-label">${e}</td>
        <td class="col-value">${Number.isFinite(t)?t:"—"}</td>
        <td class="col-bar">
          <meshcore-stacked-bar
            .segments=${i}
            .legend=${"inline"}>
          </meshcore-stacked-bar>
          ${o?j`<div class="rate-annotation">${o}</div>`:G}
        </td>
      </tr>
    `}_findByMetric(e){return this.entities.find(t=>t.metricKey===e)}_findEntityIdMatching(e){return this.entities.find(t=>t.entity_id.includes(e))}_findEntityByLabel(e){return this.entities.find(t=>t.label===e)}_readNumber(e){const t=this.hass?.states[e];if(!t||"unavailable"===t.state||"unknown"===t.state)return NaN;const i=parseFloat(t.state);return Number.isFinite(i)?i:NaN}_formatNumber(e,t){return Number.isFinite(e)?e.toFixed(t):"—"}_formatRowValue(e,t,i){if("unavailable"===i||"unknown"===i)return"—";if(!Number.isFinite(t))return i??"—";const o=this.hass?.entities?.[e.entity_id]?.display_precision;return null!=o&&o>=0?t.toFixed(o):i&&i.includes(".")?i:t.toString()}_renderInfoTip(e){return e.tooltip?j`<meshcore-info-tip
      .content=${e.tooltip}
      .source=${e.source??""}>
  ...
  `,e([ge({type:Object})],et.prototype,"hass",void 0),e([ge({type:Object})],et.prototype,"device",void 0),e([ge({type:Array})],et.prototype,"entities",void 0),e([ge({type:Number})],et.prototype,"hiddenCount",void 0),et=e([pe("meshcore-node-summary")],et);let tt=class extends ce{constructor(){super(...arguments),this.data=[],this.neighbors=[],this.width=600,this.height=200,this.timeRange=24,this.COLORS=["#FF6B6B","#4ECDC4","#FFE66D","#95E1D3","#C7CEEA","#FF8B94","#B5EAD7","#FFB7B2"]}render(){if(!this.data||0===this.data.length||0===this.neighbors.length)return j`
    ...
    `}_renderChart(){const e=50,t=this.width-100,i=this.height-100;let o=1/0,r=-1/0;this.data.forEach(e=>{Object.values(e.values).forEach(e=>{"number"==typeof e&&(o=Math.min(o,e),r=Math.max(r,e))})}),isFinite(o)&&isFinite(r)||(o=-10,r=20);const a=r-o,s=o-.1*a,n=r+.1*a,d=t=>this.height-e-(t-s)/(n-s)*i,c=60*this.timeRange*60*1e3,l=Date.now(),p=l-c,h=i=>e+(i-p)/c*t,u=[];for(let t=0;t<=5;t++){const i=s+t/5*(n-s),o=d(i);u.push(K`
        ...
        `)}const g=[];for(let t=0;t<=5;t++){const i=p+t/5*c,o=h(i),r=this._formatTimeLabel(i,l);g.push(K`
    ...
    `}_formatTimeLabel(e,t){const i=(t-e)/36e5;return i>=24?`${Math.round(i)}h ago`:0===i?"Now":`${Math.round(i)}h`}};tt.styles=s`
    :host {
      display: block;
      width: 100%;
  ...
  `,e([ge({type:Array})],tt.prototype,"data",void 0),e([ge({type:Array})],tt.prototype,"neighbors",void 0),e([ge({type:Number})],tt.prototype,"width",void 0),e([ge({type:Number})],tt.prototype,"height",void 0),e([ge({type:Number})],tt.prototype,"timeRange",void 0),tt=e([pe("meshcore-snr-chart")],tt);let it=class extends ce{constructor(){super(...arguments),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue=""}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return j`
    ...
    `}_renderParamInput(e){const t=this._paramValues[e.name]??e.default??"";switch(e.type){case"boolean":return j`
        ...
        `}}_formatValue(e){return!0===e?"Yes":!1===e?"No":null==e?"—":("string"==typeof e&&e.length,String(e))}_renderFormattedResponse(e){try{const t=JSON.parse(e);if(t&&"object"==typeof t&&!Array.isArray(t)){const e=Object.entries(t);if(e.length>0)return j`
            <div style="display: grid; grid-template-columns: auto 1fr; gap: 4px 12px; font-size: 13px;">
              ${e.map(([e,t])=>{const i=at._FRIENDLY_LABELS[e]||e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase()),o=this._formatValue(t),r="string"==typeof t&&t.length>24;return j`
      ...
      <div class="device-section" @tile-context-menu=${e=>this._onTileContextMenu(e,a)}>
        <div class="section-header">
          ...
          <div style="display:flex;align-items:center;gap:4px;">
            <button class="settings-btn" @click=${()=>this._settingsDeviceKey=a} title="Device settings">
    ...
    `],e([ge({type:Object})],ct.prototype,"hass",void 0),e([ge({type:Object})],ct.prototype,"config",void 0),e([ge({type:Boolean})],ct.prototype,"narrow",void 0),e([ge({type:Object})],ct.prototype,"selectedDevice",void 0),e([me()],ct.prototype,"_managedDevices",void 0),e([me()],ct.prototype,"_loading",void 0),e([me()],ct.prototype,"_error",void 0),e([me()],ct.prototype,"_confirmAction",void 0),e([me()],ct.prototype,"_confirmDialogOpen",void 0),e([me()],ct.prototype,"_commandDialogOpen",void 0),e([me()],ct.prototype,"_commandDialogTarget",void 0),e([me()],ct.prototype,"_commandDialogIsLocal",void 0),e([me()],ct.prototype,"_statusMessage",void 0),e([me()],ct.prototype,"_statusMessageTimeout",void 0),e([me()],ct.prototype,"_deviceEntities",void 0),e([me()],ct.prototype,"_meshcoreDeviceMap",void 0),e([me()],ct.prototype,"_entityRegistryLoaded",void 0),e([me()],ct.prototype,"_hiddenSensors",void 0),e([me()],ct.prototype,"_contextMenu",void 0),e([me()],ct.prototype,"_settingsDeviceKey",void 0),e([me()],ct.prototype,"_hiddenSensorsModalKey",void 0),e([me()],ct.prototype,"_neighborContextMenu",void 0),e([me()],ct.prototype,"_neighborData",void 0),ct=e([pe("meshcore-devices-page")],ct);let lt=class extends ce{constructor(){super(...arguments),this.selected=!1}render(){if(!this.contact)return j``;const e=this.contact,t=this._getTypeClass(e.type),{label:i,cls:o}=this._getCategoryBadge(e);return j`
  ...
  `,e([ge({type:Object})],lt.prototype,"contact",void 0),e([ge({type:Boolean})],lt.prototype,"selected",void 0),lt=e([pe("meshcore-contact-card")],lt);let pt=class extends ce{constructor(){super(...arguments),this.selected=!1}render(){if(!this.node)return j``;const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,i=e&&3===this.node.type,o=e?1===this.node.type:"client"===this.node.type,r=e&&4===this.node.type,a=e?this.node.adv_name:this.node.name,s=this.node.pubkey_prefix,n=e?this.node.last_advert:void 0;let d=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,c="Contact",l="";t?(d=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`,c="Repeater",l="repeater"):i?(d=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`,c="Room Server",l="room-server"):r?(d=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`,c="Sensor",l="sensor"):o&&(d=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`,c="Client",l="client");const p=e&&(0!==this.node.adv_lat||0!==this.node.adv_lon),h=n?new Date(1e3*n).toLocaleTimeString():"Unknown";return j`
    ...
    `}_dispatch(e){this.dispatchEvent(new CustomEvent(e,{detail:{node:this.node},bubbles:!0,composed:!0}))}};pt.styles=s`
    :host { display: block; }
  ...
  `,e([ge({type:Object})],pt.prototype,"node",void 0),e([ge({type:Boolean})],pt.prototype,"selected",void 0),pt=e([pe("meshcore-node-card")],pt);let ht=class extends ce{constructor(){super(...arguments),this.open=!1,this.pendingAction=null,this._confirming=!1,this._confirmAction=null}render(){if(!this.open||!this.node)return j``;const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,i=e&&3===this.node.type,o=e?1===this.node.type:"client"===this.node.type,r=e&&4===this.node.type,a=e?this.node.adv_name:this.node.name,s=this.node.pubkey_prefix;let n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,d="Contact",c="";return t?(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`,d="Repeater",c="repeater"):i?(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`,d="Room Server",c="room-server"):r?(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`,d="Sensor",c="sensor"):o&&(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`,d="Client",c="client"),j`
    ...
    `}_close(){this.open=!1,this._confirming=!1,this._confirmAction=null,this.dispatchEvent(new CustomEvent("node-detail-closed",{bubbles:!0,composed:!0}))}_dispatchEvent(e){this.dispatchEvent(new CustomEvent(`node-${e}`,{detail:{node:this.node},bubbles:!0,composed:!0}))}_confirmAction_exec(){this._confirmAction&&this._dispatchEvent(this._confirmAction),this._close()}};ht.styles=s`
    :host {
      display: contents;
    }
  ...
  `,e([ge({type:Object})],ht.prototype,"node",void 0),e([ge({type:Boolean})],ht.prototype,"open",void 0),e([ge({type:Object})],ht.prototype,"hass",void 0),e([ge({type:String})],ht.prototype,"pendingAction",void 0),e([me()],ht.prototype,"_confirming",void 0),e([me()],ht.prototype,"_confirmAction",void 0),ht=e([pe("meshcore-node-detail-dialog")],ht);const ut={clients:1,repeaters:2,room_servers:3,sensors:4},gt={clients:"#4caf50",repeaters:"#ff9800",room_servers:"#9c27b0",sensors:"#607d8b"},mt={clients:"Clients",repeaters:"Repeaters",room_servers:"Room Servers",sensors:"Sensors"},vt={all:"",added:"#03a9f4",discovered:"#4caf50"};let ft=class extends ce{constructor(){super(...arguments),this.contacts=[],this.channels=[],this.narrow=!1,this._viewportNarrow=!1,this._primaryFilter="all",this._typeFilter=null,this._searchQuery="",this._displayedContacts=[],this._totalCount=0,this._typeCounts={clients:0,repeaters:0,room_servers:0,sensors:0},this._l1Counts={all:0,added:0,discovered:0},this._loading=!1,this._nodeDetailDialogOpen=!1,this._pendingAction=null,this._sortBy="last_heard",this._onMediaChange=e=>{this._viewportNarrow=e.matches}}connectedCallback(){super.connectedCallback(),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaQuery.addEventListener("change",this._onMediaChange),this._loadCounts(),this._loadPage(!0)}disconnectedCallback(){super.disconnectedCallback(),this._mediaQuery?.removeEventListener("change",this._onMediaChange),this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=void 0)}get _isNarrow(){return this.narrow||this._viewportNarrow}updated(e){super.updated(e),this._isNarrow?this.setAttribute("narrow",""):this.removeAttribute("narrow")}render(){return j`
    ...
    `}_renderL1Button(e,t){const i=this._l1Counts[e],o=this._primaryFilter===e,r=vt[e];return j`
      <button
  ...
  `,e([ge({type:Array})],ft.prototype,"contacts",void 0),e([ge({type:Array})],ft.prototype,"channels",void 0),e([ge({type:Boolean})],ft.prototype,"narrow",void 0),e([ge({type:Object})],ft.prototype,"hass",void 0),e([ge({type:Object})],ft.prototype,"config",void 0),e([me()],ft.prototype,"_viewportNarrow",void 0),e([me()],ft.prototype,"_primaryFilter",void 0),e([me()],ft.prototype,"_typeFilter",void 0),e([me()],ft.prototype,"_searchQuery",void 0),e([me()],ft.prototype,"_displayedContacts",void 0),e([me()],ft.prototype,"_totalCount",void 0),e([me()],ft.prototype,"_typeCounts",void 0),e([me()],ft.prototype,"_l1Counts",void 0),e([me()],ft.prototype,"_loading",void 0),e([me()],ft.prototype,"_selectedNode",void 0),e([me()],ft.prototype,"_nodeDetailDialogOpen",void 0),e([me()],ft.prototype,"_pendingAction",void 0),e([me()],ft.prototype,"_sortBy",void 0),ft=e([pe("meshcore-nodes-page")],ft);let bt=class extends ce{constructor(){super(...arguments),this.narrow=!1,this._deviceConfig=null,this._loading=!0,this._error=null,this._editValues={},this._saving=!1,this._commandDialogOpen=!1,this._confirmAction=null,this._confirmDialogOpen=!1,this._locationSource="manual",this._importKeyValue="",this._deviceEntities={},this._meshcoreDeviceMap={},this._entityRegistryLoaded=!1,this._hiddenSensors={},this._contextMenu=null,this._overlayPointerStarted=!1,this._settingsModalOpen=!1,this._keyManagementModalOpen=!1,this._hiddenSensorsModalKey=null,this._statusMessage=null,this._statusMessageTimeout=null,this._onCompanionTrace=()=>{const e=this.selectedDevice?.entry_id;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:e},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._loadDeviceConfig(),this._loadHiddenSensors()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadDeviceConfig(),e.has("hass")&&this.hass&&!this._entityRegistryLoaded&&this._loadEntityRegistry()}async _loadDeviceConfig(){if(this.hass){this._loading=!0,this._error=null;try{this._deviceConfig=await ke(this.hass,this.config?.node_prefix),this._deviceConfig?.location_source&&(this._locationSource=this._deviceConfig.location_source)}catch(e){this._error=`Failed to load device configuration: ${String(e)}`}finally{this._loading=!1}}}render(){return this._loading?j`
    ...
    `],e([ge({type:Object})],bt.prototype,"hass",void 0),e([ge({type:Object})],bt.prototype,"config",void 0),e([ge({type:Boolean})],bt.prototype,"narrow",void 0),e([ge({type:Object})],bt.prototype,"selectedDevice",void 0),e([me()],bt.prototype,"_deviceConfig",void 0),e([me()],bt.prototype,"_loading",void 0),e([me()],bt.prototype,"_error",void 0),e([me()],bt.prototype,"_editValues",void 0),e([me()],bt.prototype,"_saving",void 0),e([me()],bt.prototype,"_commandDialogOpen",void 0),e([me()],bt.prototype,"_confirmAction",void 0),e([me()],bt.prototype,"_confirmDialogOpen",void 0),e([me()],bt.prototype,"_locationSource",void 0),e([me()],bt.prototype,"_importKeyValue",void 0),e([me()],bt.prototype,"_deviceEntities",void 0),e([me()],bt.prototype,"_meshcoreDeviceMap",void 0),e([me()],bt.prototype,"_entityRegistryLoaded",void 0),e([me()],bt.prototype,"_hiddenSensors",void 0),e([me()],bt.prototype,"_contextMenu",void 0),e([me()],bt.prototype,"_settingsModalOpen",void 0),e([me()],bt.prototype,"_keyManagementModalOpen",void 0),e([me()],bt.prototype,"_hiddenSensorsModalKey",void 0),e([me()],bt.prototype,"_statusMessage",void 0),bt=e([pe("meshcore-settings-page")],bt);let yt=class extends ce{constructor(){super(...arguments),this.open=!1,this.contactName="",this.result=null,this.error="",this.availableRepeaters=[],this.targetContact=null,this.pathMode="discovery",this.pathHops=[],this.enteredPath="",this._repeaterFilter="",this._running=!1,this._onPathModeChange=e=>{this.pathMode=e.target.value},this._onExplicitPathInput=e=>{this.enteredPath=e.target.value},this._onRunTrace=()=>{if(!this._canRunTrace())return;const e="discovery"===this.pathMode?void 0:this._buildPathString();this._running=!0,this.dispatchEvent(new CustomEvent("trace-requested",{detail:{pathMode:this.pathMode,path:e},bubbles:!0,composed:!0}))}}willUpdate(e){if(e.has("open")&&this.open&&!e.get("open")){const e=this.targetContact;if(!e||2!==e.type&&3!==e.type&&4!==e.type)this.pathMode="discovery",this.pathHops=[];else{this.pathMode="select";const t=this._resolveCachedHops(e);this.pathHops=t||[]}this.enteredPath="",this._repeaterFilter="",this._running=!1}(e.has("result")&&this.result||e.has("error")&&this.error)&&(this._running=!1)}_resolveCachedHops(e){if(1!==(e.out_path_hash_mode??0))return null;const t=(e.out_path||"").toLowerCase(),i=e.out_path_len??0;if(!t||i<=0)return null;if(t.length<4*i)return null;const o=[];for(let e=0;e<i;e++){const i=t.substring(4*e,4*(e+1)),r=this.availableRepeaters.find(e=>(e.pubkey_prefix||"").toLowerCase().startsWith(i));if(!r)return null;o.push(r)}return o}render(){return this.open?j`
      <div class="dialog-backdrop" @click=${this._close}>
        <div class="dialog" @click=${e=>e.stopPropagation()}>
          <div class="dialog-header">
    ...
    `}_addRepeater(e){this.pathHops=[...this.pathHops,e]}_removeRepeater(e){this.pathHops=this.pathHops.filter((t,i)=>i!==e)}_moveRepeater(e,t){const i=e+t;if(i<0||i>=this.pathHops.length)return;const o=[...this.pathHops];[o[e],o[i]]=[o[i],o[e]],this.pathHops=o}_isValidExplicitHops(){const e=this.enteredPath.trim();if(!e)return!0;const t=e.split(",").map(e=>e.trim());if(0===t.length)return!1;const i=t[0].length;if(![2,4,8].includes(i))return!1;const o=/^[0-9a-fA-F]+$/;return t.every(e=>e.length===i&&o.test(e))}_canRunTrace(){return"discovery"===this.pathMode||("select"===this.pathMode?!!this.targetContact:"explicit"===this.pathMode&&!!this.targetContact&&this._isValidExplicitHops())}_buildPathString(){if("select"===this.pathMode){if(!this.targetContact)return"";const e=this.targetContact.pubkey_prefix.substring(0,2).toUpperCase(),t=this.pathHops.map(e=>e.pubkey_prefix.substring(0,2).toUpperCase());return 0===t.length?e:[...t,e,...[...t].reverse()].join(",")}if("explicit"===this.pathMode){if(!this.targetContact)return"";const e=this.targetContact.pubkey_prefix.substring(0,2).toUpperCase(),t=this.enteredPath.trim();if(!t)return e;const i=t.split(",").map(e=>e.trim().toUpperCase());return[...i,e,...[...i].reverse()].join(",")}return""}_renderResult(e){const t=(e.path||[]).filter(e=>e.hash);return j`
      ...
      ${t.length>0?j`
          ...
          `:j``}
    `}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("trace-dialog-closed",{bubbles:!0,composed:!0}))}};yt.styles=[ve,s`
  ...
  `],e([ge({type:Boolean})],yt.prototype,"open",void 0),e([ge({type:String})],yt.prototype,"contactName",void 0),e([ge({type:Object})],yt.prototype,"result",void 0),e([ge({type:String})],yt.prototype,"error",void 0),e([ge({type:Array})],yt.prototype,"availableRepeaters",void 0),e([ge({type:Object})],yt.prototype,"targetContact",void 0),e([me()],yt.prototype,"pathMode",void 0),e([me()],yt.prototype,"pathHops",void 0),e([me()],yt.prototype,"enteredPath",void 0),e([me()],yt.prototype,"_repeaterFilter",void 0),e([me()],yt.prototype,"_running",void 0),yt=e([pe("meshcore-trace-dialog")],yt);let _t=class extends ce{constructor(){super(...arguments),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._boundKeydown=null,this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._boundKeydown=e=>{this.open&&"Escape"===e.key&&(e.stopPropagation(),this._close())},document.addEventListener("keydown",this._boundKeydown)}disconnectedCallback(){super.disconnectedCallback(),this._boundKeydown&&(document.removeEventListener("keydown",this._boundKeydown),this._boundKeydown=null)}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return j``;const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),o=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||o.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return j`
    ...
    `}_iconFor(e){switch(e){case 2:return j`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a2 2 0 012 2c0 .74-.4 1.39-1 1.73V10h4.27c.15-.86.45-1.66.87-2.36l-1.82-1.06a.5.5 0 01-.18-.68l.5-.87a.5.5 0 01.68-.18l1.81 1.05C19.66 4.66 20.78 4 22 4v2c-.8 0-1.54.32-2.08.84l1.5 2.6a.5.5 0 01-.18.68l-.87.5a.5.5 0 01-.68-.18L18.2 7.92c-.14.65-.2 1.33-.2 2.08 0 3.31-2.69 6-6 6s-6-2.69-6-6 2.69-6 6-6z"/></svg>`;case 3:return j`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M4 6h16v4H4V6zm0 8h16v4H4v-4zm2-6.5A.5.5 0 116 7a.5.5 0 010 .5zm0 8A.5.5 0 116 15a.5.5 0 010 .5z"/></svg>`;case 4:return j`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a4 4 0 00-4 4v7.55A5.5 5.5 0 1015.5 20a5.47 5.47 0 00.5-2.45V6a4 4 0 00-4-4zm0 2a2 2 0 012 2v8.1a3.5 3.5 0 11-4 0V6a2 2 0 012-2z"/></svg>`;default:return j`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>`}}_select(e){this.dispatchEvent(new CustomEvent("target-selected",{detail:e,bubbles:!0,composed:!0}))}};_t.styles=[ve,s`
      :host { display: contents; }
    ...
    `],e([ge({type:Object})],xt.prototype,"hass",void 0),e([ge({type:Boolean})],xt.prototype,"narrow",void 0),e([ge({type:Object})],xt.prototype,"panel",void 0),e([me()],xt.prototype,"_config",void 0),e([me()],xt.prototype,"_activeTab",void 0),e([me()],xt.prototype,"_devices",void 0),e([me()],xt.prototype,"_contacts",void 0),e([me()],xt.prototype,"_channels",void 0),e([me()],xt.prototype,"_selectedEntryId",void 0),e([me()],xt.prototype,"_loading",void 0),e([me()],xt.prototype,"_loadingStarted",void 0),e([me()],xt.prototype,"_error",void 0),e([me()],xt.prototype,"_unsubscribeList",void 0),e([me()],xt.prototype,"_unreadCounts",void 0),e([me()],xt.prototype,"_pendingChatTarget",void 0),e([me()],xt.prototype,"_traceDialogOpen",void 0),e([me()],xt.prototype,"_traceDialogContactName",void 0),e([me()],xt.prototype,"_traceDialogResult",void 0),e([me()],xt.prototype,"_traceDialogError",void 0),e([me()],xt.prototype,"_traceDialogPubkeyPrefix",void 0),e([me()],xt.prototype,"_traceDialogEntryId",void 0),e([me()],xt.prototype,"_traceDialogTargetContact",void 0),e([me()],xt.prototype,"_targetPickerOpen",void 0),e([me()],xt.prototype,"_pendingTraceEntryId",void 0),xt=e([pe("meshcore-chat-panel")],xt);export{xt as MeshCorePanel};

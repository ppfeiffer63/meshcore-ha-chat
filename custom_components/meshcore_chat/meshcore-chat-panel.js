...
`,fe=/^<[^>]+>\s*/,ye=/@\[([^\]]+)\]/g,be=/@(\w+)/g,_e={recipient_type_entity:"select.meshcore_recipient_type",channel_entity:"select.meshcore_channel",contact_entity:"select.meshcore_contact",channel_entity_pattern:"binary_sensor.meshcore_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.meshcore_{prefix}_{contact}_messages",domain_filter:"meshcore"},xe={..._e,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"relative",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function we(e,t){try{const i={type:"meshcore_chat/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch{return[]}}async function $e(e,t){try{const i={type:"meshcore_chat/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch{return[]}}async function ke(e,t){try{const i={type:"meshcore_chat/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch{throw new Error("Failed to get device configuration")}}async function Ce(e,t,i){try{const o={type:"meshcore_chat/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1,changed:[]}}}async function Se(e,t,i,o){try{const r={type:"meshcore_chat/execute_local",command:t};return i&&(r.args=i),o&&(r.entry_id=o),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function Me(e,t,i,o){try{const r={type:"meshcore_chat/execute_remote",target_prefix:t,command:i};return o&&(r.entry_id=o),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function ze(e,t,i,o){try{const r={type:"meshcore_chat/add_contact",public_key:t};return i&&(r.name=i),o&&(r.entry_id=o),await e.callWS(r)}catch{return{success:!1}}}async function Ae(e,t,i){try{const o={type:"meshcore_chat/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1}}}const De=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function Oe(e){const t=[],i=new Set;let o;const r=new RegExp(ye.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const a=new RegExp(be.source,"g");for(;null!==(o=a.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function Ie(e){return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:Oe(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count}}function Te(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function Ee(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=Math.floor((i.getTime()-o.getTime())/864e5);return 0===r?"Today":1===r?"Yesterday":r<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class Re{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"meshcore_chat/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(Ie);this._hasOlderMessages=i.has_more;const r=new Set(this._messages.map(e=>e.id)),a=o.filter(e=>!r.has(e.id));a.length>0&&(this._messages=[...a,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch{}finally{this._loadingOlder=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{const t=50,i=await this._hass.callWS({type:"meshcore_chat/get_stored_messages",entity_id:e,limit:t}),o=i.messages.map(Ie);this._hasOlderMessages=i.has_more;const r=new Set(o.map(e=>e.id)),a=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=o.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...o,...a],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const s=this._config.max_messages??500;this._messages.length>s&&(this._messages=this._messages.slice(-s),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"meshcore_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"meshcore_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){const t=e.sender_name??e.sender,i=e.message??e.text;if(t===this._config.node_name){if(t&&i){const o=e.ack_received,r=e.repeater_count,a=e.rx_log_data,s=e.message_type;let n;n="dm"===s||"direct"===s?{status:!0===o?"delivered":"sent",ackReceived:o??void 0}:{status:"sent",repeaterCount:r??a?.length??0};for(let e=this._messages.length-1;e>=0;e--){const o=this._messages[e];if(o.id.startsWith("optimistic_")&&o.sender===t&&o.text===i){o.deliveryStatus=n,a&&(o.rxLogData=a),this._notify();break}}}this._entityId&&this._debouncedFetch(this._entityId)}else{if(t&&i){let o=i.replace(fe,"");const r=t+": ";o.startsWith(r)&&(o=o.substring(r.length));const a=e.timestamp||(new Date).toISOString(),s=new Date(a),n=function(e,t,i){return function(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,r=i+9+63&-64,a=new Uint8Array(r);a.set(t),a[i]=128;const s=new DataView(a.buffer);s.setUint32(r-4,o,!1);let n=1779033703,d=3144134277,c=1013904242,l=2773480762,p=1359893119,h=2600822924,u=528734635,g=1541459225;const m=new Int32Array(64);for(let e=0;e<r;e+=64){for(let t=0;t<16;t++)m[t]=s.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(m[e-15]>>>7|m[e-15]<<25)^(m[e-15]>>>18|m[e-15]<<14)^m[e-15]>>>3,i=(m[e-2]>>>17|m[e-2]<<15)^(m[e-2]>>>19|m[e-2]<<13)^m[e-2]>>>10;m[e]=m[e-16]+t+m[e-7]+i|0}let t=n,i=d,o=c,r=l,a=p,v=h,f=u,y=g;for(let e=0;e<64;e++){const s=y+((a>>>6|a<<26)^(a>>>11|a<<21)^(a>>>25|a<<7))+(a&v^~a&f)+De[e]+m[e]|0,n=t&i^t&o^i&o;y=f,f=v,v=a,a=r+s|0,r=o,o=i,i=t,t=s+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,d=d+i|0,c=c+o|0,l=l+r|0,p=p+a|0,h=h+v|0,u=u+f|0,g=g+y|0}const v=e=>(e>>>0).toString(16).padStart(8,"0");return v(n)+v(d)+v(c)+v(l)+v(p)+v(h)+v(u)+v(g)}(`${e}|${t}|${i}`).substring(0,12)}(a,t,o),d=`rt_${n}`,c=this._messages.some(e=>e.id===d||e.id===n);if(!c){const r=Oe(o),a=e.rx_log_data,n={id:d,sender:t,text:o,timestamp:s,isOutgoing:!1,isSystem:!1,raw:i,mentions:r,rxLogData:a&&a.length>0?a:void 0};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._notify()}}this._entityId&&this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch{}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,r=e.timestamp;if(i&&o){const e=r?new Date(r).getTime():0;for(let r=this._messages.length-1;r>=0;r--){const a=this._messages[r];if(!a.isOutgoing&&a.sender===i&&a.text===o&&(!e||Math.abs(a.timestamp.getTime()-e)<1e4))return a.rxLogData=t,a.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,r=e.repeater_count,a=e.ack_received,s=e.round_trip_ms,n=e.progressive;if(!i)return;let d,c;d=o||(!0===a?"delivered":!n||void 0!==r&&0!==r?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){c=this._messages[e];break}c&&(c.deliveryStatus={status:d,repeaterCount:r,ackReceived:a,roundTripMs:s},void 0!==r&&(c.repeaterCount=r),this._notify())}async _pollFetch(e){if(this._hass)try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"meshcore_chat/get_stored_messages",entity_id:e,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i);if(0===o.messages.length)return this._error=null,void(this._retryCount=0);const r=o.messages.map(Ie),a=new Set(this._messages.map(e=>e.id)),s=r.filter(e=>!a.has(e.id));if(s.length>0){const e=new Set(s.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!s.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=this._config.max_messages??500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch{this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch{}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let Ne=class extends ce{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.searchQuery="",this.unreadCounts={},this._activeFilter="all",this._filteredConversations=[]}updated(e){(e.has("conversations")||e.has("searchQuery")||e.has("_activeFilter"))&&this._updateFiltered()}render(){const e=this.searchQuery.length>0;return j`
  ...
  `,e([ge({type:Object})],Le.prototype,"hass",void 0),e([ge({type:String})],Le.prototype,"entryId",void 0),e([ge({type:Boolean})],Le.prototype,"narrow",void 0),e([me()],Le.prototype,"_activeTab",void 0),e([me()],Le.prototype,"_contacts",void 0),e([me()],Le.prototype,"_channels",void 0),e([me()],Le.prototype,"_searchQuery",void 0),e([me()],Le.prototype,"_loading",void 0),e([me()],Le.prototype,"_actionInProgress",void 0),e([me()],Le.prototype,"_confirmingRemoveContact",void 0),e([me()],Le.prototype,"_confirmingRemoveChannel",void 0),e([me()],Le.prototype,"_channelDialogOpen",void 0),e([me()],Le.prototype,"_editingChannel",void 0),e([me()],Le.prototype,"_maxChannels",void 0),Le=e([pe("meshcore-manage-dialog")],Le);const qe=e=>(...t)=>({_$litDirective$:e,values:t});class Pe{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}class He extends Pe{constructor(e){if(super(e),this.it=G,2!==e.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===G||null==e)return this._t=void 0,this.it=e;if(e===U)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}He.directiveName="unsafeHTML",He.resultType=1;const Be=qe(He);let Ve=class extends ce{constructor(){super(...arguments),this.timestampFormat="relative",this._selectedMessage=null}render(){return this.group?j`
        ${this._renderGroup()}
  ...
  `,e([ge({type:String})],Ze.prototype,"content",void 0),e([ge({type:String})],Ze.prototype,"source",void 0),e([ge({type:String})],Ze.prototype,"glyph",void 0),Ze=e([pe("meshcore-info-tip")],Ze);let et=class extends ce{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0}render(){if(!this.hass||!this.device)return G;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return j`
    ...
    `}_renderMessagesSentTile(e){const t=this._findEntityIdMatching("nb_sent"),i=this._findEntityIdMatching("sent_flood"),o=this._findEntityIdMatching("sent_direct");if(!t||!i&&!o)return G;const r=this._readNumber(t.entity_id),a=i?this._readNumber(i.entity_id):0,s=o?this._readNumber(o.entity_id):0,n=Math.max(0,r-a-s),d=[{value:a,label:`Flood ${a}`,kind:"flood"},{value:s,label:`Direct ${s}`,kind:"direct"},{value:n,label:`Other ${n}`,kind:"other"}],c=this._readDerivedRate(t.entity_id,"nb_sent"),l=Number.isFinite(c)?`${c.toFixed(1)} msg/min`:void 0;return e.add(t.entity_id),i&&e.add(i.entity_id),o&&e.add(o.entity_id),j`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(t.entity_id)}>
        <div class="hero-tile-head">
          <span>Messages Sent${this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages sent (lifetime). Bar segmented by send mode: Flood (broadcast retransmits visible to all neighbours); Direct (routed point-to-point along a path); Other (any sent packet counted in the total but not classified — typically zero; the firmware design reconciles flood + direct with nb_sent)."})}</span>
    ...
    `}_renderMessagesReceivedTile(e){const t=this._findEntityIdMatching("nb_recv"),i=this._findEntityIdMatching("recv_flood"),o=this._findEntityIdMatching("recv_direct"),r=this._findEntityIdMatching("flood_dups"),a=this._findEntityIdMatching("direct_dups");if(!t||!i&&!o)return G;const s=this._readNumber(t.entity_id),n=i?this._readNumber(i.entity_id):0,d=o?this._readNumber(o.entity_id):0,c=Math.max(0,s-n-d),l=[{value:n,label:`Flood ${n}`,kind:"flood"},{value:d,label:`Direct ${d}`,kind:"direct"},{value:c,label:`Other ${c}`,kind:"other"}],p=r?this._readNumber(r.entity_id):0,h=a?this._readNumber(a.entity_id):0,u=(Number.isFinite(p)?p:0)+(Number.isFinite(h)?h:0),g=s>0?u/s*100:0,m=Ye("duplicate_ratio",g).band,v=this._readDerivedRate(t.entity_id,"nb_recv"),f=Number.isFinite(v)?`${v.toFixed(1)} msg/min`:void 0;return e.add(t.entity_id),i&&e.add(i.entity_id),o&&e.add(o.entity_id),r&&e.add(r.entity_id),a&&e.add(a.entity_id),j`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(t.entity_id)}>
        <div class="hero-tile-head">
          <span>Messages Received${this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages received (lifetime). Bar segmented by receive mode: Flood (broadcast packets received and re-transmitted on this repeater); Direct (routed packets where this repeater is on the path). Duplicates are tracked separately and do NOT contribute to the total — they appear as an annotation. Dup ratio bands: Green < 5%, Yellow 5–10%, Red > 10%. High dup rate suggests network loops or path degradation."})}</span>
  ...
  `,e([ge({type:Array})],ft.prototype,"contacts",void 0),e([ge({type:Array})],ft.prototype,"channels",void 0),e([ge({type:Boolean})],ft.prototype,"narrow",void 0),e([ge({type:Object})],ft.prototype,"hass",void 0),e([ge({type:Object})],ft.prototype,"config",void 0),e([me()],ft.prototype,"_viewportNarrow",void 0),e([me()],ft.prototype,"_primaryFilter",void 0),e([me()],ft.prototype,"_typeFilter",void 0),e([me()],ft.prototype,"_searchQuery",void 0),e([me()],ft.prototype,"_displayedContacts",void 0),e([me()],ft.prototype,"_totalCount",void 0),e([me()],ft.prototype,"_typeCounts",void 0),e([me()],ft.prototype,"_l1Counts",void 0),e([me()],ft.prototype,"_loading",void 0),e([me()],ft.prototype,"_selectedNode",void 0),e([me()],ft.prototype,"_nodeDetailDialogOpen",void 0),e([me()],ft.prototype,"_pendingAction",void 0),e([me()],ft.prototype,"_sortBy",void 0),ft=e([pe("meshcore-nodes-page")],ft);let yt=class extends ce{constructor(){super(...arguments),this.narrow=!1,this._deviceConfig=null,this._loading=!0,this._error=null,this._editValues={},this._saving=!1,this._commandDialogOpen=!1,this._confirmAction=null,this._confirmDialogOpen=!1,this._locationSource="manual",this._importKeyValue="",this._deviceEntities={},this._meshcoreDeviceMap={},this._entityRegistryLoaded=!1,this._hiddenSensors={},this._contextMenu=null,this._overlayPointerStarted=!1,this._settingsModalOpen=!1,this._keyManagementModalOpen=!1,this._hiddenSensorsModalKey=null,this._statusMessage=null,this._statusMessageTimeout=null,this._onCompanionTrace=()=>{const e=this.selectedDevice?.entry_id;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:e},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._loadDeviceConfig(),this._loadHiddenSensors()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadDeviceConfig(),e.has("hass")&&this.hass&&!this._entityRegistryLoaded&&this._loadEntityRegistry()}async _loadDeviceConfig(){if(this.hass){this._loading=!0,this._error=null;try{this._deviceConfig=await ke(this.hass,this.config?.node_prefix),this._deviceConfig?.location_source&&(this._locationSource=this._deviceConfig.location_source)}catch(e){this._error=`Failed to load device configuration: ${String(e)}`}finally{this._loading=!1}}}render(){return this._loading?j`
    ...
    `],e([ge({type:Object})],yt.prototype,"hass",void 0),e([ge({type:Object})],yt.prototype,"config",void 0),e([ge({type:Boolean})],yt.prototype,"narrow",void 0),e([ge({type:Object})],yt.prototype,"selectedDevice",void 0),e([me()],yt.prototype,"_deviceConfig",void 0),e([me()],yt.prototype,"_loading",void 0),e([me()],yt.prototype,"_error",void 0),e([me()],yt.prototype,"_editValues",void 0),e([me()],yt.prototype,"_saving",void 0),e([me()],yt.prototype,"_commandDialogOpen",void 0),e([me()],yt.prototype,"_confirmAction",void 0),e([me()],yt.prototype,"_confirmDialogOpen",void 0),e([me()],yt.prototype,"_locationSource",void 0),e([me()],yt.prototype,"_importKeyValue",void 0),e([me()],yt.prototype,"_deviceEntities",void 0),e([me()],yt.prototype,"_meshcoreDeviceMap",void 0),e([me()],yt.prototype,"_entityRegistryLoaded",void 0),e([me()],yt.prototype,"_hiddenSensors",void 0),e([me()],yt.prototype,"_contextMenu",void 0),e([me()],yt.prototype,"_settingsModalOpen",void 0),e([me()],yt.prototype,"_keyManagementModalOpen",void 0),e([me()],yt.prototype,"_hiddenSensorsModalKey",void 0),e([me()],yt.prototype,"_statusMessage",void 0),yt=e([pe("meshcore-settings-page")],yt);let bt=class extends ce{constructor(){super(...arguments),this.open=!1,this.contactName="",this.result=null,this.error="",this.availableRepeaters=[],this.targetContact=null,this.pathMode="discovery",this.pathHops=[],this.enteredPath="",this._repeaterFilter="",this._running=!1,this._onPathModeChange=e=>{this.pathMode=e.target.value},this._onExplicitPathInput=e=>{this.enteredPath=e.target.value},this._onRunTrace=()=>{if(!this._canRunTrace())return;const e="discovery"===this.pathMode?void 0:this._buildPathString();this._running=!0,this.dispatchEvent(new CustomEvent("trace-requested",{detail:{pathMode:this.pathMode,path:e},bubbles:!0,composed:!0}))}}willUpdate(e){if(e.has("open")&&this.open&&!e.get("open")){const e=this.targetContact;if(!e||2!==e.type&&3!==e.type&&4!==e.type)this.pathMode="discovery",this.pathHops=[];else{this.pathMode="select";const t=this._resolveCachedHops(e);this.pathHops=t||[]}this.enteredPath="",this._repeaterFilter="",this._running=!1}(e.has("result")&&this.result||e.has("error")&&this.error)&&(this._running=!1)}_resolveCachedHops(e){if(1!==(e.out_path_hash_mode??0))return null;const t=(e.out_path||"").toLowerCase(),i=e.out_path_len??0;if(!t||i<=0)return null;if(t.length<4*i)return null;const o=[];for(let e=0;e<i;e++){const i=t.substring(4*e,4*(e+1)),r=this.availableRepeaters.find(e=>(e.pubkey_prefix||"").toLowerCase().startsWith(i));if(!r)return null;o.push(r)}return o}render(){return this.open?j`
      <div class="dialog-backdrop" @click=${this._close}>
        <div class="dialog" @click=${e=>e.stopPropagation()}>
          <div class="dialog-header">

...
`,fe=/^<[^>]+>\s*/,be=/@\[([^\]]+)\]/g,ye=/@(\w+)/g,_e={recipient_type_entity:"select.meshcore_recipient_type",channel_entity:"select.meshcore_channel",contact_entity:"select.meshcore_contact",channel_entity_pattern:"binary_sensor.meshcore_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.meshcore_{prefix}_{contact}_messages",domain_filter:"meshcore"},xe={..._e,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"relative",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function we(e,t){try{const i={type:"meshcore_chat/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch{return[]}}async function $e(e,t){try{const i={type:"meshcore_chat/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch{return[]}}async function ke(e,t){try{const i={type:"meshcore_chat/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch{throw new Error("Failed to get device configuration")}}async function Ce(e,t,i){try{const o={type:"meshcore_chat/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1,changed:[]}}}async function Se(e,t,i,o){try{const r={type:"meshcore_chat/execute_local",command:t};return i&&(r.args=i),o&&(r.entry_id=o),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function Me(e,t,i,o){try{const r={type:"meshcore_chat/execute_remote",target_prefix:t,command:i};return o&&(r.entry_id=o),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function ze(e,t,i,o){try{const r={type:"meshcore_chat/add_contact",public_key:t};return i&&(r.name=i),o&&(r.entry_id=o),await e.callWS(r)}catch{return{success:!1}}}async function Ae(e,t,i){try{const o={type:"meshcore_chat/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1}}}const De=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function Oe(e){const t=[],i=new Set;let o;const r=new RegExp(be.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const a=new RegExp(ye.source,"g");for(;null!==(o=a.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function Ee(e){return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:Oe(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count}}function Ie(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function Te(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=Math.floor((i.getTime()-o.getTime())/864e5);return 0===r?"Today":1===r?"Yesterday":r<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class Re{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"meshcore_chat/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(Ee);this._hasOlderMessages=i.has_more;const r=new Set(this._messages.map(e=>e.id)),a=o.filter(e=>!r.has(e.id));a.length>0&&(this._messages=[...a,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch{}finally{this._loadingOlder=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{const t=50,i=await this._hass.callWS({type:"meshcore_chat/get_stored_messages",entity_id:e,limit:t}),o=i.messages.map(Ee);this._hasOlderMessages=i.has_more;const r=new Set(o.map(e=>e.id)),a=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=o.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...o,...a],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const s=this._config.max_messages??500;this._messages.length>s&&(this._messages=this._messages.slice(-s),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"meshcore_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"meshcore_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){const t=e.sender_name??e.sender,i=e.message??e.text;if(t===this._config.node_name){if(t&&i){const o=e.ack_received,r=e.repeater_count,a=e.rx_log_data,s=e.message_type;let n;n="dm"===s||"direct"===s?{status:!0===o?"delivered":"sent",ackReceived:o??void 0}:{status:"sent",repeaterCount:r??a?.length??0};for(let e=this._messages.length-1;e>=0;e--){const o=this._messages[e];if(o.id.startsWith("optimistic_")&&o.sender===t&&o.text===i){o.deliveryStatus=n,a&&(o.rxLogData=a),this._notify();break}}}this._entityId&&this._debouncedFetch(this._entityId)}else{if(t&&i){let o=i.replace(fe,"");const r=t+": ";o.startsWith(r)&&(o=o.substring(r.length));const a=e.timestamp||(new Date).toISOString(),s=new Date(a),n=function(e,t,i){return function(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,r=i+9+63&-64,a=new Uint8Array(r);a.set(t),a[i]=128;const s=new DataView(a.buffer);s.setUint32(r-4,o,!1);let n=1779033703,c=3144134277,d=1013904242,l=2773480762,p=1359893119,h=2600822924,u=528734635,g=1541459225;const m=new Int32Array(64);for(let e=0;e<r;e+=64){for(let t=0;t<16;t++)m[t]=s.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(m[e-15]>>>7|m[e-15]<<25)^(m[e-15]>>>18|m[e-15]<<14)^m[e-15]>>>3,i=(m[e-2]>>>17|m[e-2]<<15)^(m[e-2]>>>19|m[e-2]<<13)^m[e-2]>>>10;m[e]=m[e-16]+t+m[e-7]+i|0}let t=n,i=c,o=d,r=l,a=p,v=h,f=u,b=g;for(let e=0;e<64;e++){const s=b+((a>>>6|a<<26)^(a>>>11|a<<21)^(a>>>25|a<<7))+(a&v^~a&f)+De[e]+m[e]|0,n=t&i^t&o^i&o;b=f,f=v,v=a,a=r+s|0,r=o,o=i,i=t,t=s+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,c=c+i|0,d=d+o|0,l=l+r|0,p=p+a|0,h=h+v|0,u=u+f|0,g=g+b|0}const v=e=>(e>>>0).toString(16).padStart(8,"0");return v(n)+v(c)+v(d)+v(l)+v(p)+v(h)+v(u)+v(g)}(`${e}|${t}|${i}`).substring(0,12)}(a,t,o),c=`rt_${n}`,d=this._messages.some(e=>e.id===c||e.id===n);if(!d){const r=Oe(o),a=e.rx_log_data,n={id:c,sender:t,text:o,timestamp:s,isOutgoing:!1,isSystem:!1,raw:i,mentions:r,rxLogData:a&&a.length>0?a:void 0};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._notify()}}this._entityId&&this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch{}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,r=e.timestamp;if(i&&o){const e=r?new Date(r).getTime():0;for(let r=this._messages.length-1;r>=0;r--){const a=this._messages[r];if(!a.isOutgoing&&a.sender===i&&a.text===o&&(!e||Math.abs(a.timestamp.getTime()-e)<1e4))return a.rxLogData=t,a.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,r=e.repeater_count,a=e.ack_received,s=e.round_trip_ms,n=e.progressive;if(!i)return;let c,d;c=o||(!0===a?"delivered":!n||void 0!==r&&0!==r?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:c,repeaterCount:r,ackReceived:a,roundTripMs:s},void 0!==r&&(d.repeaterCount=r),this._notify())}async _pollFetch(e){if(this._hass)try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"meshcore_chat/get_stored_messages",entity_id:e,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i);if(0===o.messages.length)return this._error=null,void(this._retryCount=0);const r=o.messages.map(Ee),a=new Set(this._messages.map(e=>e.id)),s=r.filter(e=>!a.has(e.id));if(s.length>0){const e=new Set(s.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!s.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=this._config.max_messages??500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch{this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch{}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let Fe=class extends de{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.unreadCounts={},this._activeFilter="all",this._filteredConversations=[]}updated(e){(e.has("conversations")||e.has("_activeFilter"))&&this._updateFiltered()}render(){return j`
  ...
  `,e([ge({type:Array})],Fe.prototype,"conversations",void 0),e([ge({type:String})],Fe.prototype,"activeId",void 0),e([ge({type:Object})],Fe.prototype,"unreadCounts",void 0),e([me()],Fe.prototype,"_activeFilter",void 0),e([me()],Fe.prototype,"_filteredConversations",void 0),Fe=e([pe("meshcore-conversation-list")],Fe);const Ne=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","),Le=[];let qe=!1;function Pe(){qe||(qe=!0,document.addEventListener("keydown",Be,!0))}function Be(e){0!==Le.length&&Le[Le.length-1]._handleKeyDown(e)}class He{constructor(e,t){this.host=e,this.opts=t,this._wasOpen=!1,this._previousActive=null,this._inStack=!1,this.host.addController(this),Pe()}hostConnected(){Pe()}hostDisconnected(){this._inStack&&this._popStack(),this._previousActive=null,this._wasOpen=!1}hostUpdated(){const e=this.opts.isOpen();if(e&&!this._wasOpen)this._previousActive=this._currentDocumentActive(),this._pushStack(),this._focusFirstSoon();else if(!e&&this._wasOpen){this._popStack();const e=this._previousActive;if(this._previousActive=null,e&&e.isConnected&&"function"==typeof e.focus)try{e.focus()}catch{}}this._wasOpen=e}_pushStack(){this._inStack||(Le.push(this),this._inStack=!0)}_popStack(){const e=Le.indexOf(this);e>=0&&Le.splice(e,1),this._inStack=!1}_getFocusables(){const e=this.opts.getScope?.()??this.host.shadowRoot;return e?Array.from(e.querySelectorAll(Ne)).filter(e=>!(e.hasAttribute("aria-hidden")||e.hidden||null===e.offsetParent&&0===e.getClientRects().length)):[]}_focusFirstSoon(){queueMicrotask(()=>{if(!this.opts.isOpen())return;const e=this.opts.getScope?.()??this.host.shadowRoot;if(e&&this._scopeContainsFocus(e))return;const t=this._getFocusables();if(0!==t.length)try{t[0].focus()}catch{}})}_scopeContainsFocus(e){let t=document.activeElement;for(;t;){if(t===e)return!0;if(e.host===t)return!0;if("contains"in e&&e.contains(t))return!0;const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return!1}_currentDocumentActive(){let e=document.activeElement;for(;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_handleKeyDown(e){if(!this.opts.isOpen())return;if("Escape"===e.key)return e.preventDefault(),e.stopPropagation(),void this.opts.onEscape();if("Tab"!==e.key)return;const t=this._getFocusables();if(0===t.length)return;const i=t[0],o=t[t.length-1],r=this.opts.getScope?.()??this.host.shadowRoot,a=r?this._findFocusedInScope(r):null;if(!a)return e.preventDefault(),e.stopPropagation(),void(e.shiftKey?o:i).focus();e.shiftKey&&a===i?(e.preventDefault(),e.stopPropagation(),o.focus()):e.shiftKey||a!==o||(e.preventDefault(),e.stopPropagation(),i.focus())}_findFocusedInScope(e){let t=document.activeElement;for(;t;){if(e===t||"contains"in e&&e.contains(t)){if(t.shadowRoot&&t.shadowRoot.activeElement){t=t.shadowRoot.activeElement;continue}return t}if(e.host===t){t=e.activeElement;continue}const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return null}}function Ve(e,t){new He(e,t)}let je=class extends de{constructor(){super(),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._saving=!1,this._error=null,this._initialized=!1,Ve(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}willUpdate(e){e.has("open")&&this.open&&!this._initialized&&(this.editMode?(this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName):this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0,this._initialized=!0),e.has("open")&&!this.open&&(this._initialized=!1)}render(){if(!this.open)return;const e=this._customKey.length,t=64===e||0===e||this._autoKey;return j`
    ...
    `],e([ge({type:Boolean})],je.prototype,"open",void 0),e([ge({type:Object})],je.prototype,"hass",void 0),e([ge({type:String})],je.prototype,"entryId",void 0),e([ge({type:Boolean})],je.prototype,"narrow",void 0),e([ge({type:Boolean})],je.prototype,"editMode",void 0),e([ge({type:Number})],je.prototype,"initialChannelIdx",void 0),e([ge({type:String})],je.prototype,"initialChannelName",void 0),e([ge({type:Array})],je.prototype,"availableIndices",void 0),e([me()],je.prototype,"_channelIdx",void 0),e([me()],je.prototype,"_channelName",void 0),e([me()],je.prototype,"_customKey",void 0),e([me()],je.prototype,"_autoKey",void 0),e([me()],je.prototype,"_saving",void 0),e([me()],je.prototype,"_error",void 0),je=e([pe("meshcore-channel-dialog")],je);let Ke=class extends de{constructor(){super(),this.narrow=!1,this._activeTab="contacts",this._contacts=[],this._channels=[],this._searchQuery="",this._categoryFilter="all",this._typeFilter="all",this._loading=!1,this._actionInProgress=null,this._confirmingRemoveContact=null,this._confirmingRemoveChannel=null,this._channelDialogOpen=!1,this._editingChannel=null,this._maxChannels=4,Ve(this,{isOpen:()=>!0,onEscape:()=>this._close()})}connectedCallback(){super.connectedCallback(),this._loadData()}render(){return j`
      <div
        class="dialog"
        role="dialog"
        aria-modal="true"
  ...
  `,e([ge({type:Object})],Ke.prototype,"hass",void 0),e([ge({type:String})],Ke.prototype,"entryId",void 0),e([ge({type:Boolean})],Ke.prototype,"narrow",void 0),e([me()],Ke.prototype,"_activeTab",void 0),e([me()],Ke.prototype,"_contacts",void 0),e([me()],Ke.prototype,"_channels",void 0),e([me()],Ke.prototype,"_searchQuery",void 0),e([me()],Ke.prototype,"_categoryFilter",void 0),e([me()],Ke.prototype,"_typeFilter",void 0),e([me()],Ke.prototype,"_loading",void 0),e([me()],Ke.prototype,"_actionInProgress",void 0),e([me()],Ke.prototype,"_confirmingRemoveContact",void 0),e([me()],Ke.prototype,"_confirmingRemoveChannel",void 0),e([me()],Ke.prototype,"_channelDialogOpen",void 0),e([me()],Ke.prototype,"_editingChannel",void 0),e([me()],Ke.prototype,"_maxChannels",void 0),Ke=e([pe("meshcore-manage-dialog")],Ke);let Ue=class extends de{constructor(){super(),this.timestampFormat="relative",this._selectedMessage=null,Ve(this,{isOpen:()=>null!==this._selectedMessage,onEscape:()=>{this._selectedMessage=null},getScope:()=>this.shadowRoot?.querySelector(".message-dialog")})}render(){return this.group?j`
        ${this._renderGroup()}
  ...
  `,e([ge({type:Object})],Ue.prototype,"group",void 0),e([ge({type:Object})],Ue.prototype,"message",void 0),e([ge({type:String})],Ue.prototype,"timestampFormat",void 0),e([me()],Ue.prototype,"_selectedMessage",void 0),Ue=e([pe("meshcore-message-bubble")],Ue);let Ge=class extends de{constructor(){super(),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null,Ve(this,{isOpen:()=>!0,onEscape:()=>this.dispatchEvent(new CustomEvent("search-close",{bubbles:!0,composed:!0}))})}render(){return j`
  ...
  `,e([ge({type:Array})],ot.prototype,"segments",void 0),e([ge({type:Number})],ot.prototype,"total",void 0),e([ge({type:String})],ot.prototype,"legend",void 0),e([ge({type:String})],ot.prototype,"extraLegendText",void 0),ot=e([pe("meshcore-stacked-bar")],ot);let rt=class extends de{constructor(){super(...arguments),this.content="",this.glyph="ⓘ"}render(){return this.content?j`
  ...
  `,e([ge({type:String})],rt.prototype,"content",void 0),e([ge({type:String})],rt.prototype,"source",void 0),e([ge({type:String})],rt.prototype,"glyph",void 0),rt=e([pe("meshcore-info-tip")],rt);let at=class extends de{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0}render(){if(!this.hass||!this.device)return G;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return j`
      <div class="hero-row">
        ${t}
      </div>
    ...
    `}_renderMessagesReceivedTile(e){const t=this._findEntityIdMatching("nb_recv"),i=this._findEntityIdMatching("recv_flood"),o=this._findEntityIdMatching("recv_direct"),r=this._findEntityIdMatching("flood_dups"),a=this._findEntityIdMatching("direct_dups");if(!t||!i&&!o)return G;const s=this._readNumber(t.entity_id),n=i?this._readNumber(i.entity_id):0,c=o?this._readNumber(o.entity_id):0,d=Math.max(0,s-n-c),l=[{value:n,label:`Flood ${n}`,kind:"flood"},{value:c,label:`Direct ${c}`,kind:"direct"},{value:d,label:`Other ${d}`,kind:"other"}],p=r?this._readNumber(r.entity_id):0,h=a?this._readNumber(a.entity_id):0,u=(Number.isFinite(p)?p:0)+(Number.isFinite(h)?h:0),g=s>0?u/s*100:0,m=this._readDerivedRate(t.entity_id,"nb_recv"),v=Number.isFinite(m)?`${m.toFixed(1)} msg/min`:void 0;return e.add(t.entity_id),i&&e.add(i.entity_id),o&&e.add(o.entity_id),r&&e.add(r.entity_id),a&&e.add(a.entity_id),j`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(t.entity_id)}>
        <div class="hero-tile-head">
        ...
        ${u>0?j`<div class="dup-annotation">
  ...
  `,e([ge({type:Object})],at.prototype,"hass",void 0),e([ge({type:Object})],at.prototype,"device",void 0),e([ge({type:Array})],at.prototype,"entities",void 0),e([ge({type:Number})],at.prototype,"hiddenCount",void 0),e([ge({type:Number})],at.prototype,"fallbackLatitude",void 0),e([ge({type:Number})],at.prototype,"fallbackLongitude",void 0),e([ge({type:Number})],at.prototype,"fallbackUpdated",void 0),at=e([pe("meshcore-node-summary")],at);let st=class extends de{constructor(){super(...arguments),this.data=[],this.neighbors=[],this.width=600,this.height=200,this.timeRange=24,this.COLORS=["#FF6B6B","#4ECDC4","#FFE66D","#95E1D3","#C7CEEA","#FF8B94","#B5EAD7","#FFB7B2"]}render(){if(!this.data||0===this.data.length||0===this.neighbors.length)return j`
    ...
    `}_renderChart(){const e=50,t=this.width-100,i=this.height-100;let o=1/0,r=-1/0;this.data.forEach(e=>{Object.values(e.values).forEach(e=>{"number"==typeof e&&(o=Math.min(o,e),r=Math.max(r,e))})}),isFinite(o)&&isFinite(r)||(o=-10,r=20);const a=r-o,s=o-.1*a,n=r+.1*a,c=t=>this.height-e-(t-s)/(n-s)*i,d=60*this.timeRange*60*1e3,l=Date.now(),p=l-d,h=i=>e+(i-p)/d*t,u=[];for(let t=0;t<=5;t++){const i=s+t/5*(n-s),o=c(i);u.push(K`
        ...
        `)}const g=[];for(let t=0;t<=5;t++){const i=p+t/5*d,o=h(i),r=this._formatTimeLabel(i,l);g.push(K`
  ...
  `,e([ge({type:Array})],st.prototype,"data",void 0),e([ge({type:Array})],st.prototype,"neighbors",void 0),e([ge({type:Number})],st.prototype,"width",void 0),e([ge({type:Number})],st.prototype,"height",void 0),e([ge({type:Number})],st.prototype,"timeRange",void 0),st=e([pe("meshcore-snr-chart")],st);let nt=class extends de{constructor(){super(),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue="",Ve(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return j`
    ...
    `],e([ge({type:Object})],gt.prototype,"hass",void 0),e([ge({type:Object})],gt.prototype,"config",void 0),e([ge({type:Boolean})],gt.prototype,"narrow",void 0),e([ge({type:Object})],gt.prototype,"selectedDevice",void 0),e([me()],gt.prototype,"_managedDevices",void 0),e([me()],gt.prototype,"_contactsByPrefix",void 0),e([me()],gt.prototype,"_loading",void 0),e([me()],gt.prototype,"_error",void 0),e([me()],gt.prototype,"_confirmAction",void 0),e([me()],gt.prototype,"_confirmDialogOpen",void 0),e([me()],gt.prototype,"_commandDialogOpen",void 0),e([me()],gt.prototype,"_commandDialogTarget",void 0),e([me()],gt.prototype,"_commandDialogIsLocal",void 0),e([me()],gt.prototype,"_statusMessage",void 0),e([me()],gt.prototype,"_statusMessageTimeout",void 0),e([me()],gt.prototype,"_deviceEntities",void 0),e([me()],gt.prototype,"_meshcoreDeviceMap",void 0),e([me()],gt.prototype,"_entityRegistryLoaded",void 0),e([me()],gt.prototype,"_hiddenSensors",void 0),e([me()],gt.prototype,"_contextMenu",void 0),e([me()],gt.prototype,"_settingsDeviceKey",void 0),e([me()],gt.prototype,"_hiddenSensorsModalKey",void 0),e([me()],gt.prototype,"_neighborContextMenu",void 0),e([me()],gt.prototype,"_neighborData",void 0),gt=e([pe("meshcore-devices-page")],gt);let mt=class extends de{constructor(){super(...arguments),this.selected=!1}render(){if(!this.contact)return j``;const e=this.contact,t=this._getTypeClass(e.type),{label:i,cls:o}=this._getCategoryBadge(e);return j`
  ...
  `],e([ge({type:Boolean})],wt.prototype,"open",void 0),e([ge({type:String})],wt.prototype,"contactName",void 0),e([ge({type:Object})],wt.prototype,"result",void 0),e([ge({type:String})],wt.prototype,"error",void 0),e([ge({type:Array})],wt.prototype,"availableRepeaters",void 0),e([ge({type:Object})],wt.prototype,"targetContact",void 0),e([me()],wt.prototype,"pathMode",void 0),e([me()],wt.prototype,"pathHops",void 0),e([me()],wt.prototype,"enteredPath",void 0),e([me()],wt.prototype,"_repeaterFilter",void 0),e([me()],wt.prototype,"_running",void 0),wt=e([pe("meshcore-trace-dialog")],wt);let $t=class extends de{constructor(){super(),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))},Ve(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return j``;const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),o=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||o.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return j`
    ...
    `],e([ge({type:Object})],kt.prototype,"hass",void 0),e([ge({type:Boolean})],kt.prototype,"narrow",void 0),e([ge({type:Object})],kt.prototype,"panel",void 0),e([me()],kt.prototype,"_config",void 0),e([me()],kt.prototype,"_activeTab",void 0),e([me()],kt.prototype,"_devices",void 0),e([me()],kt.prototype,"_contacts",void 0),e([me()],kt.prototype,"_channels",void 0),e([me()],kt.prototype,"_selectedEntryId",void 0),e([me()],kt.prototype,"_loading",void 0),e([me()],kt.prototype,"_loadingStarted",void 0),e([me()],kt.prototype,"_error",void 0),e([me()],kt.prototype,"_unsubscribeList",void 0),e([me()],kt.prototype,"_unreadCounts",void 0),e([me()],kt.prototype,"_pendingChatTarget",void 0),e([me()],kt.prototype,"_traceDialogOpen",void 0),e([me()],kt.prototype,"_traceDialogContactName",void 0),e([me()],kt.prototype,"_traceDialogResult",void 0),e([me()],kt.prototype,"_traceDialogError",void 0),e([me()],kt.prototype,"_traceDialogPubkeyPrefix",void 0),e([me()],kt.prototype,"_traceDialogEntryId",void 0),e([me()],kt.prototype,"_traceDialogTargetContact",void 0),e([me()],kt.prototype,"_targetPickerOpen",void 0),e([me()],kt.prototype,"_pendingTraceEntryId",void 0),kt=e([pe("meshcore-chat-panel")],kt);export{kt as MeshCorePanel};

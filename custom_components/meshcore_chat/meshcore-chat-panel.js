                    ...
                    <select
                      ...
                      ${this._devices.map(e=>j`
                          <option value=${e.entry_id}>
                            ${e.name} (${e.pubkey_prefix?.substring(0,6)||"?"})${e.connected?"":" — offline"}
                          </option>
                        `)}
                    </select>

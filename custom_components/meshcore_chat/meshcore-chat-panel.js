...
`,fe=/^<[^>]+>\s*/,ye=/@\[([^\]]+)\]/g,be=/@(\w+)/g,_e={recipient_type_entity:"select.meshcore_recipient_type",channel_entity:"select.meshcore_channel",contact_entity:"select.meshcore_contact",channel_entity_pattern:"binary_sensor.meshcore_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.meshcore_{prefix}_{contact}_messages",domain_filter:"meshcore"},xe={..._e,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"relative",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function we(e,t){try{const o={type:"meshcore_chat/get_contacts"};return t&&(o.entry_id=t),(await e.callWS(o)).contacts||[]}catch{return[]}}async function $e(e,t){try{const o={type:"meshcore_chat/get_channels"};return t&&(o.entry_id=t),(await e.callWS(o)).channels||[]}catch{return[]}}async function ke(e,t){try{const o={type:"meshcore_chat/get_device_config"};return t&&(o.entry_id=t),await e.callWS(o)}catch{throw new Error("Failed to get device configuration")}}async function Ce(e,t,o){try{const i={type:"meshcore_chat/set_device_config",settings:t};return o&&(i.entry_id=o),await e.callWS(i)}catch{return{success:!1,changed:[]}}}async function Se(e,t,o,i){try{const r={type:"meshcore_chat/execute_local",command:t};return o&&(r.args=o),i&&(r.entry_id=i),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function Me(e,t,o,i){try{const r={type:"meshcore_chat/execute_remote",target_prefix:t,command:o};return i&&(r.entry_id=i),await e.callWS(r)}catch(e){return{response:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function ze(e,t,o,i){try{const r={type:"meshcore_chat/add_contact",public_key:t};return o&&(r.name=o),i&&(r.entry_id=i),await e.callWS(r)}catch{return{success:!1}}}async function Ae(e,t,o){try{const i={type:"meshcore_chat/remove_contact",public_key:t};return o&&(i.entry_id=o),await e.callWS(i)}catch{return{success:!1}}}const De=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function Oe(e){const t=[],o=new Set;let i;const r=new RegExp(ye.source,"g");for(;null!==(i=r.exec(e));){const e=i[1];o.has(e)||(o.add(e),t.push(e))}const s=new RegExp(be.source,"g");for(;null!==(i=s.exec(e));){const e=i[1];o.has(e)||(o.add(e),t.push(e))}return t}function Ie(e){return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:Oe(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count}}function Ee(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function Te(e){const t=new Date,o=new Date(t.getFullYear(),t.getMonth(),t.getDate()),i=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=Math.floor((o.getTime()-i.getTime())/864e5);return 0===r?"Today":1===r?"Yesterday":r<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class Re{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const o=new Date,i={id:`optimistic_${o.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:o,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,i],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"meshcore_chat/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const o=await this._hass.callWS(t),i=o.messages.map(Ie);this._hasOlderMessages=o.has_more;const r=new Set(this._messages.map(e=>e.id)),s=i.filter(e=>!r.has(e.id));s.length>0&&(this._messages=[...s,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch{}finally{this._loadingOlder=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),o=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(o)return!0;let i=0;for(;this._hasOlderMessages&&i<20;){await this.loadOlderMessages(),i++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{const t=50,o=await this._hass.callWS({type:"meshcore_chat/get_stored_messages",entity_id:e,limit:t}),i=o.messages.map(Ie);this._hasOlderMessages=o.has_more;const r=new Set(i.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=i.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...i,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const a=this._config.max_messages??500;this._messages.length>a&&(this._messages=this._messages.slice(-a),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"meshcore_message");t.push(o);const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"meshcore_delivery_update");t.push(i),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){const t=e.sender_name??e.sender,o=e.message??e.text;if(t===this._config.node_name){if(t&&o){const i=e.ack_received,r=e.repeater_count,s=e.rx_log_data,a=e.message_type;let n;n="dm"===a||"direct"===a?{status:!0===i?"delivered":"sent",ackReceived:i??void 0}:{status:"sent",repeaterCount:r??s?.length??0};for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e];if(i.id.startsWith("optimistic_")&&i.sender===t&&i.text===o){i.deliveryStatus=n,s&&(i.rxLogData=s),this._notify();break}}}this._entityId&&this._debouncedFetch(this._entityId)}else{if(t&&o){let i=o.replace(fe,"");const r=t+": ";i.startsWith(r)&&(i=i.substring(r.length));const s=e.timestamp||(new Date).toISOString(),a=new Date(s),n=function(e,t,o){return function(e){const t=(new TextEncoder).encode(e),o=t.length,i=8*o,r=o+9+63&-64,s=new Uint8Array(r);s.set(t),s[o]=128;const a=new DataView(s.buffer);a.setUint32(r-4,i,!1);let n=1779033703,c=3144134277,d=1013904242,l=2773480762,p=1359893119,h=2600822924,g=528734635,m=1541459225;const u=new Int32Array(64);for(let e=0;e<r;e+=64){for(let t=0;t<16;t++)u[t]=a.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(u[e-15]>>>7|u[e-15]<<25)^(u[e-15]>>>18|u[e-15]<<14)^u[e-15]>>>3,o=(u[e-2]>>>17|u[e-2]<<15)^(u[e-2]>>>19|u[e-2]<<13)^u[e-2]>>>10;u[e]=u[e-16]+t+u[e-7]+o|0}let t=n,o=c,i=d,r=l,s=p,v=h,f=g,y=m;for(let e=0;e<64;e++){const a=y+((s>>>6|s<<26)^(s>>>11|s<<21)^(s>>>25|s<<7))+(s&v^~s&f)+De[e]+u[e]|0,n=t&o^t&i^o&i;y=f,f=v,v=s,s=r+a|0,r=i,i=o,o=t,t=a+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,c=c+o|0,d=d+i|0,l=l+r|0,p=p+s|0,h=h+v|0,g=g+f|0,m=m+y|0}const v=e=>(e>>>0).toString(16).padStart(8,"0");return v(n)+v(c)+v(d)+v(l)+v(p)+v(h)+v(g)+v(m)}(`${e}|${t}|${o}`).substring(0,12)}(s,t,i),c=`rt_${n}`,d=this._messages.some(e=>e.id===c||e.id===n);if(!d){const r=Oe(i),s=e.rx_log_data,n={id:c,sender:t,text:i,timestamp:a,isOutgoing:!1,isSystem:!1,raw:o,mentions:r,rxLogData:s&&s.length>0?s:void 0};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._notify()}}this._entityId&&this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch{}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const o=e.sender_name,i=e.message,r=e.timestamp;if(o&&i){const e=r?new Date(r).getTime():0;for(let r=this._messages.length-1;r>=0;r--){const s=this._messages[r];if(!s.isOutgoing&&s.sender===o&&s.text===i&&(!e||Math.abs(s.timestamp.getTime()-e)<1e4))return s.rxLogData=t,s.repeaterCount=t.length,void this._notify()}}}const o=e.send_id,i=e.status,r=e.repeater_count,s=e.ack_received,a=e.round_trip_ms,n=e.progressive;if(!o)return;let c,d;c=i||(!0===s?"delivered":!n||void 0!==r&&0!==r?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:c,repeaterCount:r,ackReceived:s,roundTripMs:a},void 0!==r&&(d.repeaterCount=r),this._notify())}async _pollFetch(e){if(this._hass)try{let t;for(let e=this._messages.length-1;e>=0;e--){const o=this._messages[e].id;if(!o.startsWith("rt_")&&!o.startsWith("optimistic_")){t=o;break}}const o={type:"meshcore_chat/get_stored_messages",entity_id:e,limit:50};t&&(o.after=t);const i=await this._hass.callWS(o);if(0===i.messages.length)return this._error=null,void(this._retryCount=0);const r=i.messages.map(Ie),s=new Set(this._messages.map(e=>e.id)),a=r.filter(e=>!s.has(e.id));if(a.length>0){const e=new Set(a.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!a.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...a],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=this._config.max_messages??500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch{this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const o=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch{}t()}},o)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let Fe=class extends de{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.searchQuery="",this.unreadCounts={},this._activeFilter="all",this._filteredConversations=[]}updated(e){(e.has("conversations")||e.has("searchQuery")||e.has("_activeFilter"))&&this._updateFiltered()}render(){const e=this.searchQuery.length>0;return j`
  ...
  `,e([me({type:Array})],Fe.prototype,"conversations",void 0),e([me({type:String})],Fe.prototype,"activeId",void 0),e([me({type:String})],Fe.prototype,"searchQuery",void 0),e([me({type:Object})],Fe.prototype,"unreadCounts",void 0),e([ue()],Fe.prototype,"_activeFilter",void 0),e([ue()],Fe.prototype,"_filteredConversations",void 0),Fe=e([pe("meshcore-conversation-list")],Fe);let Ne=class extends de{constructor(){super(...arguments),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._saving=!1,this._error=null,this._initialized=!1}willUpdate(e){e.has("open")&&this.open&&!this._initialized&&(this.editMode?(this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName):this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0,this._initialized=!0),e.has("open")&&!this.open&&(this._initialized=!1)}render(){if(!this.open)return;const e=this._customKey.length,t=64===e||0===e||this._autoKey;return j`
    ...
    `}_renderContacts(){const e=this._filterContacts();if(0===e.length)return j`
      ...
      `;const t=[...e].sort((e,t)=>e.added_to_node!==t.added_to_node?e.added_to_node?-1:1:e.adv_name.localeCompare(t.adv_name));return t.map(e=>this._renderContactItem(e))}_renderContactItem(e){const t=e.pubkey_prefix.substring(0,2).toUpperCase(),o=e.added_to_node,i=this._confirmingRemoveContact===e.public_key,r=this._actionInProgress===e.public_key;return j`
      <div class="contact-item">
        ...
        <div class="contact-info">
          ...
          <div class="contact-meta">
            ...
            <span class="badge ${o?"added":"discovered"}">
              ${o?j`<svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="vertical-align: -1px; margin-right: 2px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Added`:"Discovered"}
            </span>
          </div>
        </div>
        ${i?j`
    ...
    `}_renderChannels(){if(0===this._channels.length)return j`
      ...
      ${this._channels.map(t=>{const o=e===t.channel_idx,i=this._actionInProgress===`ch-${t.channel_idx}`;return j`
  ...
  `,e([me({type:Object})],Le.prototype,"hass",void 0),e([me({type:String})],Le.prototype,"entryId",void 0),e([me({type:Boolean})],Le.prototype,"narrow",void 0),e([ue()],Le.prototype,"_activeTab",void 0),e([ue()],Le.prototype,"_contacts",void 0),e([ue()],Le.prototype,"_channels",void 0),e([ue()],Le.prototype,"_searchQuery",void 0),e([ue()],Le.prototype,"_loading",void 0),e([ue()],Le.prototype,"_actionInProgress",void 0),e([ue()],Le.prototype,"_confirmingRemoveContact",void 0),e([ue()],Le.prototype,"_confirmingRemoveChannel",void 0),e([ue()],Le.prototype,"_channelDialogOpen",void 0),e([ue()],Le.prototype,"_editingChannel",void 0),e([ue()],Le.prototype,"_maxChannels",void 0),Le=e([pe("meshcore-manage-dialog")],Le);const qe=e=>(...t)=>({_$litDirective$:e,values:t});class Pe{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}class He extends Pe{constructor(e){if(super(e),this.it=W,2!==e.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===W||null==e)return this._t=void 0,this.it=e;if(e===U)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}He.directiveName="unsafeHTML",He.resultType=1;const Be=qe(He);let Ve=class extends de{constructor(){super(...arguments),this.timestampFormat="relative",this._selectedMessage=null}render(){return this.group?j`
    ...
    `}_renderBubble(e){const t={bubble:!0,incoming:!e.isOutgoing&&!e.isSystem,outgoing:e.isOutgoing,system:e.isSystem},o=e.isOutgoing&&e.deliveryStatus?this._getStatusLabel(e.deliveryStatus):"",i=function(e,t){switch(t){case"relative":default:return function(e){const t=Date.now()-e.getTime(),o=Math.floor(t/1e3),i=Math.floor(o/60),r=Math.floor(i/60);return o<60?"now":i<60?`${i}m`:r<24?`${r}h`:e.toLocaleDateString(void 0,{month:"short",day:"numeric"})}(e);case"time":return e.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"});case"datetime":return e.toLocaleString(void 0,{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}}(e.timestamp,this.timestampFormat);return j`
      <div class=${this._classMap(t)} data-msg-id=${e.id} @click=${t=>{t.stopPropagation(),this._selectedMessage=e}}>
        ...
        <div class="timestamp">${o?j`<span class="delivery-status">${o}</span> · `:""}${i}</div>
      </div>
    `}_getStatusLabel(e){const t=e.status,o=e.repeaterCount??0;switch(t){case"pending":case"waiting":return"Waiting...";case"sent":return o>0?"Repeated":"Unheard";case"delivered":return"Delivered";case"failed":return"Failed";default:return"Sent"}}_renderTextWithMentions(e,t){let o=e;const i=new Set(t);for(const e of i){const t=new RegExp(`@\\[${e}\\]`,"g");o=o.replace(t,`<span class="mention">@${e}</span>`)}for(const e of i){const t=new RegExp(`@${e}\\b`,"g");o=o.replace(t,`<span class="mention">@${e}</span>`)}return Be(o)}_renderMessageDialog(e){const t=e.rxLogData&&e.rxLogData.length>0,o=t?e.rxLogData.map(e=>{const t=e.path_nodes,o=e.hop_count,i=e.snr,r=e.rssi,s=[];return t&&t.length>0?s.push(t.map(e=>e.substring(0,4).toUpperCase()).join(" > ")):void 0!==o?s.push(`${o} hop${1!==o?"s":""}`):s.push("0 hops"),void 0!==i&&s.push(`SNR: ${i}`),void 0!==r&&s.push(`RSSI: ${r}`),s.join(" · ")}).join(" | "):"",i=e.timestamp.toLocaleString(void 0,{weekday:"short",month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit",second:"2-digit"}),r="padding: 8px 16px; font-size: 12px; color: var(--secondary-text-color); border-top: 1px solid var(--divider-color, #e0e0e0);";return j`
      <div class="message-dialog-overlay" @click=${()=>{this._selectedMessage=null}}>
        <div class="message-dialog" @click=${e=>e.stopPropagation()}>
          ...
          ${e.isOutgoing||e.isSystem?j``:j`
              ...
              `}
          ${t?j`
                <div class="message-dialog-route" @click=${()=>this._copyText(o)}>
                  Route: ${o}
                </div>
              `:j``}
          <div style=${r}>
            ${e.isOutgoing?"Sent":"Received"}: ${i}
          </div>
  ...
  `,e([me({type:Object})],Ve.prototype,"group",void 0),e([me({type:Object})],Ve.prototype,"message",void 0),e([me({type:String})],Ve.prototype,"timestampFormat",void 0),e([ue()],Ve.prototype,"_selectedMessage",void 0),Ve=e([pe("meshcore-message-bubble")],Ve);let je=class extends de{constructor(){super(...arguments),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null}render(){return j`
    ...
    `}_renderResult(e){const t=new Date(e.timestamp),o=t.toLocaleDateString(void 0,{month:"short",day:"numeric"}),i=t.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),r=this._highlightQuery(e.text);return j`
    ...
    `}_highlightQuery(e){if(!this._query.trim())return e;const t=this._query.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),o=new RegExp(`(${t})`,"gi"),i=e.split(o),r=this._query.toLowerCase();return i.map(e=>e.toLowerCase()===r?j`<mark>${e}</mark>`:e)}_onQueryInput(e){this._query=e.target.value,null!==this._debounceTimer&&clearTimeout(this._debounceTimer),this._query.trim().length>=2?this._debounceTimer=window.setTimeout(()=>this._doSearch(),400):(this._results=[],this._hasSearched=!1)}async _doSearch(){if(this.hass&&this._query.trim()&&this.entityId){this._searching=!0,this._hasSearched=!0;try{const e={type:"meshcore_chat/search_stored_messages",query:this._query.trim(),entity_id:this.entityId,limit:100};if(this._fromDate&&(e.from_date=new Date(this._fromDate).toISOString()),this._toDate){const t=new Date(this._toDate);t.setHours(23,59,59,999),e.to_date=t.toISOString()}const t=await this.hass.callWS(e);this._results=t.results||[],this._totalCount=this._results.length}catch{this._results=[],this._totalCount=0}finally{this._searching=!1}}}_onResultClick(e){this.dispatchEvent(new CustomEvent("result-selected",{detail:{entityId:e.entity_id,messageId:e.id,conversationName:e.conversation_name,timestamp:e.timestamp},bubbles:!0,composed:!0}))}};je.styles=a`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([me({type:Object})],je.prototype,"hass",void 0),e([me({type:String})],je.prototype,"entryId",void 0),e([me({type:String})],je.prototype,"entityId",void 0),e([me({type:String})],je.prototype,"meshNodeName",void 0),e([ue()],je.prototype,"_query",void 0),e([ue()],je.prototype,"_fromDate",void 0),e([ue()],je.prototype,"_toDate",void 0),e([ue()],je.prototype,"_results",void 0),e([ue()],je.prototype,"_totalCount",void 0),e([ue()],je.prototype,"_searching",void 0),e([ue()],je.prototype,"_hasSearched",void 0),e([ue()],je.prototype,"_showFilters",void 0),je=e([pe("meshcore-message-search")],je);let Ke=class extends de{constructor(){super(...arguments),this.conversations=[],this.selectedId=null,this.narrow=!1,this.unreadCounts={},this._messageStore=null,this._inputText="",this._sending=!1,this._viewportNarrow=!1,this._mediaQuery=null,this._mediaHandler=null,this._narrowShowMessages=!1,this._manageOpen=!1,this._searchOpen=!1,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._scrollInFlight=!1,this._scrollGuardUntil=0,this._lastMessageCount=0,this._unreadCountAtSelection=0}get _isNarrow(){return this.narrow||this._viewportNarrow}connectedCallback(){super.connectedCallback(),this.config&&!this._messageStore&&(this._messageStore=new Re(this.config),this._messageStore.setOnChange(()=>this.requestUpdate())),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaHandler=e=>{this._viewportNarrow=e.matches},this._mediaQuery.addEventListener("change",this._mediaHandler)}disconnectedCallback(){super.disconnectedCallback(),this._messageStore&&(this._messageStore.destroy(),this._messageStore=null),this._mediaQuery&&this._mediaHandler&&(this._mediaQuery.removeEventListener("change",this._mediaHandler),this._mediaQuery=null,this._mediaHandler=null)}updated(e){if(e.has("hass")&&this.hass&&this._messageStore&&this._messageStore.setHass(this.hass),e.has("config")&&this.config&&this._messageStore&&this._messageStore.setConfig(this.config),e.has("selectedId")&&this._onConversationSelected(),e.has("conversations")&&!this.selectedId&&!this._isNarrow&&this.conversations.length>0){const e=this.conversations[0],t="pubkey_prefix"in e;this.selectedId=t?e.pubkey_prefix:String(e.channel_idx)}if(this._pendingScroll){const e=this._messageStore,t=e&&!e.loading;t&&e.messages.length>0?(this._executeScroll(this._pendingScroll),this._pendingScroll=null,this._lastMessageCount=e.messages.length):t&&0===e.messages.length&&(this._pendingScroll=null)}else if(this._messageStore){const e=this._messageStore.messages.length;e>this._lastMessageCount&&this._lastMessageCount>0&&(this._scrollToBottomIfNearEnd(),this._markActiveRead(this._currentEntityId)),this._lastMessageCount=e}}render(){return this._isNarrow?this._narrowShowMessages?j`
    ...
    `}_renderChatArea(){if(!this._messageStore||!this.selectedId)return j`
      ...
      `;const e=this._messageStore.messages,t=function(e,t){const o=!1!==t.group_messages?function(e,t){if(0===e.length)return[];const o=[];let i=null;for(const r of e)!i||r.isSystem||i.isSystem||r.sender!==i.sender||(r.timestamp.getTime()-i.endTime.getTime())/1e3>t?(i={sender:r.sender,isOutgoing:r.isOutgoing,isSystem:r.isSystem,messages:[r],startTime:r.timestamp,endTime:r.timestamp},o.push(i)):(i.messages.push(r),i.endTime=r.timestamp);return o}(e,t.group_timeout??300):e.map(e=>({sender:e.sender,isOutgoing:e.isOutgoing,isSystem:e.isSystem,messages:[e],startTime:e.timestamp,endTime:e.timestamp}));if(0===o.length)return[];const i=[];let r=null;for(const e of o){const o=e.startTime;!1===t.show_date_separators||r&&!Ee(r,o)||i.push({type:"date-separator",date:o,label:Te(o)}),i.push({type:"group",group:e}),r=o}return i}(e,{group_messages:this.config?.group_messages??!0,group_timeout:this.config?.group_timeout??300,show_date_separators:this.config?.show_date_separators??!0});return j`
    ...
    `}_renderItemsWithDivider(e){const t=[];let o=0,i=!1,r=null;if(this._unreadCountAtSelection>0){const t=e.filter(e=>"date-separator"!==e.type).length-this._unreadCountAtSelection;r=t>=0?t:0}for(const s of e)"date-separator"!==s.type?(i||null===r||o!==r||(t.push(j`
      ...
      `),o++):t.push(j`
        ...
        `);return t}_onConversationSelected(){if(this.selectedId&&this._messageStore&&this.config&&this.hass){const e=this.conversations.find(e=>"pubkey_prefix"in e?e.pubkey_prefix===this.selectedId:String(e.channel_idx)===this.selectedId);if(!e)return this._conversationResolved=!1,this._currentEntityId=null,void(this._messageStore&&this._messageStore.switchEntity(null));this._conversationResolved=!0;let t=null;if("pubkey_prefix"in e){const o=e.pubkey_prefix;t=function(e,t,o){const i=o.substring(0,6);if(t.contact_entity_pattern&&t.node_prefix){const o=t.contact_entity_pattern.replace("{prefix}",t.node_prefix).replace("{contact}",i);if(e.states[o])return o}const r=`_${i}_messages`,s=t.node_prefix?`_${t.node_prefix}_`:"";for(const t of Object.keys(e.states))if(t.startsWith("binary_sensor.")&&t.endsWith(r)&&(!s||t.includes(s)))return t;return null}(this.hass,this.config,o)}else{const o=e.channel_idx;t=function(e,t,o){if(t.channel_entity_pattern&&t.node_prefix){const i=t.channel_entity_pattern.replace("{prefix}",t.node_prefix).replace("{idx}",String(o));if(e.states[i])return i}const i=`_ch_${o}_messages`,r=t.node_prefix?`_${t.node_prefix}_`:"";for(const t of Object.keys(e.states))if(t.startsWith("binary_sensor.")&&t.endsWith(i)&&(!r||t.includes(r)))return t;return null}(this.hass,this.config,o)}this._currentEntityId=t,this.dispatchEvent(new CustomEvent("active-entity-changed",{detail:{entityId:t},bubbles:!0,composed:!0}));const o=this._getUnreadCountForSelected();this._pendingScroll=o>0?"last-read":"bottom",this._unreadCountAtSelection=o,this._lastMessageCount=0,this._messageStore.switchEntity(t),this._markActiveRead(t)}}async _sendMessage(){if(this._sending||!this._inputText.trim()||!this.selectedId||!this.hass||!this.config)return;if(!this._conversationResolved)return void console.warn("Cannot send — conversation not resolved");this._sending=!0;const e=this._inputText.trim();this._inputText="";try{if(this._messageStore&&(this._messageStore.addOptimisticMessage(this.config.node_name,e),this._pendingScroll="bottom"),this._isContact())await async function(e,t,o){try{await e.callService("meshcore","send_message",{pubkey_prefix:t,message:o})}catch(e){throw new Error(`Failed to send direct message: ${String(e)}`)}}(this.hass,this.selectedId,e);else{const t=parseInt(this.selectedId,10);if(isNaN(t)||t<0||t>255)return console.error("Invalid channel index:",this.selectedId),void(this._inputText=e);await async function(e,t,o){try{await e.callService("meshcore","send_channel_message",{channel_idx:t,message:o})}catch(e){throw new Error(`Failed to send channel message: ${String(e)}`)}}(this.hass,t,e)}}catch(t){console.error("Failed to send message:",t),this._inputText=e}finally{this._sending=!1}}_markActiveRead(e){e&&this.hass&&(async function(e,t,o){try{const i={type:"meshcore_chat/mark_conversation_read",entity_id:t};return o&&(i.entry_id=o),await e.callWS(i)}catch{return{success:!1}}}(this.hass,e,this.config?.entry_id).catch(()=>{}),this.dispatchEvent(new CustomEvent("unread-cleared",{detail:{entityId:e},bubbles:!0,composed:!0})))}_isContact(){return!!this.selectedId&&!/^\d+$/.test(this.selectedId)}_onManageRequested(){this._manageOpen=!0}_onContactsChanged(){this.dispatchEvent(new CustomEvent("contacts-changed",{bubbles:!0,composed:!0}))}_onChannelsChanged(){this.dispatchEvent(new CustomEvent("channels-changed",{bubbles:!0,composed:!0}))}_onReplyToSender(e){const{mention:t}=e.detail;t&&(this._inputText=t+this._inputText,this.requestUpdate())}_getConversationName(){if(!this.selectedId)return"";const e=this.conversations.find(e=>"pubkey_prefix"in e?e.pubkey_prefix===this.selectedId:String(e.channel_idx)===this.selectedId);return e?"pubkey_prefix"in e?e.adv_name:e.name:this.selectedId}_getChatContainer(){return this.renderRoot?.querySelector(".chat-container")}_isScrollGuarded(){return this._scrollInFlight||Date.now()<this._scrollGuardUntil}_executeScroll(e){this._scrollInFlight=!0,"last-read"===e&&(this._scrollGuardUntil=Date.now()+2e3),this._doScrollWithRetry(e,0)}_doScrollWithRetry(e,t){this.updateComplete.then(()=>{requestAnimationFrame(()=>{requestAnimationFrame(()=>{const o=this._getChatContainer();if(!o)return void(this._scrollInFlight=!1);if("bottom"===e)return o.scrollTop=o.scrollHeight,void(this._scrollInFlight=!1);const i=o.querySelector(".unread-divider");if(i){const e=o.getBoundingClientRect(),t=i.getBoundingClientRect();o.scrollTop+=t.top-e.top,this._scrollInFlight=!1}else t<10?setTimeout(()=>this._doScrollWithRetry(e,t+1),50):(o.scrollTop=o.scrollHeight,this._scrollInFlight=!1)})})})}_scrollToBottomIfNearEnd(){this._isScrollGuarded()||this.updateComplete.then(()=>{requestAnimationFrame(()=>{if(this._isScrollGuarded())return;const e=this._getChatContainer();e&&e.scrollHeight-e.scrollTop-e.clientHeight<100&&(e.scrollTop=e.scrollHeight)})})}_onChatScroll(e){const t=e.target;if(t&&this._messageStore&&t.scrollTop<150&&this._messageStore.hasOlderMessages&&!this._messageStore.loadingOlder){const e=t.scrollHeight;this._messageStore.loadOlderMessages().then(()=>{this.updateComplete.then(()=>{requestAnimationFrame(()=>{const o=t.scrollHeight-e;o>0&&(t.scrollTop+=o)})})})}}_getUnreadCountForSelected(){if(!this.selectedId||!this.unreadCounts)return 0;if(this._currentEntityId&&this.unreadCounts[this._currentEntityId])return this.unreadCounts[this._currentEntityId];for(const[e,t]of Object.entries(this.unreadCounts))if(!(t<=0))if(/^\d+$/.test(this.selectedId)){if(e.endsWith(`_ch_${this.selectedId}_messages`))return t}else{const o=this.selectedId.substring(0,6);if(e.endsWith(`_${o}_messages`))return t}return 0}_onSearchResultSelected(e){const{entityId:t,messageId:o,timestamp:i}=e.detail;t&&this._messageStore&&(this._messageStore.switchEntity(t),this._currentEntityId=t),o&&this._scrollToAndHighlight(o,i)}_scrollToAndHighlight(e,t){this.updateComplete.then(()=>{requestAnimationFrame(()=>{this._findAndHighlightBubble(e)||t&&this._messageStore&&this._messageStore.fetchAroundTimestamp(t).then(t=>{t&&this.updateComplete.then(()=>{requestAnimationFrame(()=>{this._findAndHighlightBubble(e)})})})})})}_findAndHighlightBubble(e){const t=this.shadowRoot?.querySelector(".chat-container");if(!t)return!1;const o=t.querySelectorAll("meshcore-message-bubble");for(const t of Array.from(o)){const o=t.shadowRoot?.querySelector(`[data-msg-id="${e}"]`);if(o)return o.scrollIntoView({behavior:"smooth",block:"center"}),o.classList.add("search-highlight"),setTimeout(()=>o.classList.remove("search-highlight"),2500),!0}return!1}};Ke.styles=a`
    :host {
      display: flex;
      width: 100%;
      height: 100%;
  ...
  `,e([me({type:Object})],We.prototype,"hass",void 0),e([me({type:String})],We.prototype,"entityId",void 0),e([me({type:String})],We.prototype,"label",void 0),e([me({type:String})],We.prototype,"icon",void 0),e([me({type:String})],We.prototype,"colorScheme",void 0),We=e([pe("meshcore-sensor-tile")],We);let Ge=class extends de{constructor(){super(...arguments),this.data=[],this.neighbors=[],this.width=600,this.height=200,this.timeRange=24,this.COLORS=["#FF6B6B","#4ECDC4","#FFE66D","#95E1D3","#C7CEEA","#FF8B94","#B5EAD7","#FFB7B2"]}render(){if(!this.data||0===this.data.length||0===this.neighbors.length)return j`
      ...
      <div class="chart-container">
        ${e}
        <div class="legend">
          ${this.neighbors.map((e,t)=>{const o=this.COLORS[t%this.COLORS.length];return j`
              <div class="legend-item">
                <div class="legend-dot" style="background-color: ${o}"></div>
                <span>${e}</span>
              </div>
            `})}
        </div>
      </div>
    `}_renderChart(){const e=50,t=this.width-100,o=this.height-100;let i=1/0,r=-1/0;this.data.forEach(e=>{Object.values(e.values).forEach(e=>{"number"==typeof e&&(i=Math.min(i,e),r=Math.max(r,e))})}),isFinite(i)&&isFinite(r)||(i=-10,r=20);const s=r-i,a=i-.1*s,n=r+.1*s,c=t=>this.height-e-(t-a)/(n-a)*o,d=60*this.timeRange*60*1e3,l=Date.now(),p=l-d,h=o=>e+(o-p)/d*t,g=[];for(let t=0;t<=5;t++){const o=a+t/5*(n-a),i=c(o);g.push(K`
          <line x1="${e}" y1="${i}" x2="${this.width-e}" y2="${i}"
            stroke="var(--divider-color, #e0e0e0)" stroke-dasharray="4,4" opacity="0.3" />
          <text x="${42}" y="${i+4}" font-size="10" text-anchor="end"
            fill="var(--secondary-text-color, #727272)">${Math.round(o)}dB</text>
        `)}const m=[];for(let t=0;t<=5;t++){const o=p+t/5*d,i=h(o),r=this._formatTimeLabel(o,l);m.push(K`
          <text x="${i}" y="${this.height-e+16}" font-size="10" text-anchor="middle"
            fill="var(--secondary-text-color, #727272)">${r}</text>
        `)}const u=this.neighbors.map((e,t)=>{const o=this.COLORS[t%this.COLORS.length],i=[];return this.data.forEach(t=>{const o=t.values[e];if("number"==typeof o&&isFinite(o)){const e=h(t.timestamp),r=c(o);i.push(`${e},${r}`)}}),0===i.length?K``:K`
        <polyline points="${i.join(" ")}" fill="none" stroke="${o}"
    ...
    `}_formatTimeLabel(e,t){const o=(t-e)/36e5;return o>=24?`${Math.round(o)}h ago`:0===o?"Now":`${Math.round(o)}h`}};Ge.styles=a`
    :host {
      display: block;
      width: 100%;
  ...
  `,e([me({type:Array})],Ge.prototype,"data",void 0),e([me({type:Array})],Ge.prototype,"neighbors",void 0),e([me({type:Number})],Ge.prototype,"width",void 0),e([me({type:Number})],Ge.prototype,"height",void 0),e([me({type:Number})],Ge.prototype,"timeRange",void 0),Ge=e([pe("meshcore-snr-chart")],Ge);let Xe=class extends de{constructor(){super(...arguments),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue=""}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return j`
    ...
    `}_renderParamInput(e){const t=this._paramValues[e.name]??e.default??"";switch(e.type){case"boolean":return j`
        ...
        `;case"number":return j`
          <div class="form-group">
            ...
            <input
              ...
              ?max=${e.max}
              .value=${String(t)}
              @input=${t=>{const o=t.target;this._paramValues[e.name]=o.value?Number(o.value):""}}
            />
            ${e.description?j`<div class="form-description">${e.description}</div>`:""}
          </div>
        `;default:return j`
        ...
        `}}_formatValue(e){return!0===e?"Yes":!1===e?"No":null==e?"—":("string"==typeof e&&e.length,String(e))}_renderFormattedResponse(e){try{const t=JSON.parse(e);if(t&&"object"==typeof t&&!Array.isArray(t)){const e=Object.entries(t);if(e.length>0)return j`
            <div style="display: grid; grid-template-columns: auto 1fr; gap: 4px 12px; font-size: 13px;">
              ${e.map(([e,t])=>{const o=Je._FRIENDLY_LABELS[e]||e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase()),i=this._formatValue(t),r="string"==typeof t&&t.length>24;return j`
                  <div style="color: var(--secondary-text-color); white-space: nowrap;">${o}</div>
                  <div style="font-family: var(--code-font-family, monospace); word-break: ${r?"break-all":"normal"};">${i}</div>
                `})}
            </div>
          `}if(Array.isArray(t))return j`<pre style="margin: 0; white-space: pre-wrap; font-size: 13px;">${JSON.stringify(t,null,2)}</pre>`}catch{}return e}_onCommandSelected(e){const t=e.target.value,o=this._getCommands();this._selectedCommand=o.find(e=>e.name===t)||null,this._paramValues={},this._response=null,this._error=null}async _executeCommand(){if(this._selectedCommand&&this.hass){this._executing=!0,this._response=null,this._error=null;try{let e;if(this.isLocal)e=await Se(this.hass,this._selectedCommand.name,Object.keys(this._paramValues).length>0?this._paramValues:void 0,this.entryId);else{if(!this.targetPrefix)return void(this._error="No target device specified");const t=this._paramValues;let o=this._selectedCommand.name;if(Object.keys(t).length>0){const e=Object.entries(t).map(([,e])=>String(e)).join(" ");o=`${o} ${e}`}e=await Me(this.hass,this.targetPrefix,o,this.entryId)}e.success?this._response=e.response:this._error=e.response||"Command execution failed"}catch(e){this._error=`Error: ${String(e)}`}finally{this._executing=!1}}}_onOverlayClick(e){e.target===e.currentTarget&&this._onClose()}_onClose(){this._selectedCommand=null,this._paramValues={},this._response=null,this._error=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}};function et(e){const t=e.entity_id,o=e.original_device_class??null;if(t.startsWith("binary_sensor.meshcore_")&&"connectivity"===o)return null;if(t.startsWith("binary_sensor.meshcore_"))return null;if(t.includes("node_status")||t.includes("companion_prefix")||t.includes("request_rate")||t.includes("delivery")||t.includes("path_")||t.includes("neighbor_"))return null;if("battery"===o)return{entity_id:t,label:"Battery",icon:"battery",colorScheme:"battery",sortOrder:1};if("voltage"===o)return{entity_id:t,label:"Voltage",icon:"power",colorScheme:"neutral",sortOrder:2};if("duration"===o)return{entity_id:t,label:"Uptime",icon:"clock",colorScheme:"neutral",sortOrder:3};if("signal_strength"===o)return{entity_id:t,label:"TX Power",icon:"power",colorScheme:"neutral",sortOrder:6};if("temperature"===o)return{entity_id:t,label:"Temperature",icon:"thermometer",colorScheme:"neutral",sortOrder:7};if("power_factor"===o){const e=t.includes("rx_")?"RX Airtime Util":"Airtime Util";return{entity_id:t,label:e,icon:"chart",colorScheme:"neutral",sortOrder:10}}if(t.includes("snr")&&!t.includes("neighbor"))return{entity_id:t,label:"SNR",icon:"signal",colorScheme:"signal",sortOrder:4};if(t.includes("rssi"))return{entity_id:t,label:"RSSI",icon:"signal",colorScheme:"signal",sortOrder:5};if(t.includes("contact_count"))return{entity_id:t,label:"Contacts",icon:"counter",colorScheme:"neutral",sortOrder:8};if(t.includes("airtime")||t.includes("air_util"))return{entity_id:t,label:"Airtime",icon:"chart",colorScheme:"neutral",sortOrder:9};if(t.includes("channel_util"))return{entity_id:t,label:"Channel Util",icon:"chart",colorScheme:"neutral",sortOrder:10};if(t.startsWith("sensor.meshcore_")){const o=e.original_name||e.name||t.split(".")[1];return{entity_id:t,label:o,icon:"",colorScheme:"neutral",sortOrder:99}}return null}async function tt(e){const[t,o]=await Promise.all([e.callWS({type:"config/device_registry/list"}),e.callWS({type:"config/entity_registry/list"})]),i={};for(const e of t)if(e.identifiers)for(const[t,o]of e.identifiers)"meshcore"===t&&(i[o]=e.id);const r={};for(const e of o){if(!e.device_id||e.disabled_by)continue;if(!e.entity_id.startsWith("sensor.meshcore_")&&!e.entity_id.startsWith("binary_sensor.meshcore_"))continue;const t=et(e);t&&(r[e.device_id]||(r[e.device_id]=[]),r[e.device_id].push(t))}for(const e of Object.keys(r))r[e].sort((e,t)=>e.sortOrder-t.sortOrder);return{meshcoreDeviceMap:i,deviceEntities:r}}Ze.styles=[ve,a`
      :host {
        display: block;
      }
    ...
    `:j`<div class="content-area"><div class="loading-state"><div class="loading-spinner"></div> Initializing...</div></div>`}_renderDeviceSections(e,t){return e.map(e=>this._renderDeviceSection(e,t))}_renderDeviceSection(e,t){let o="unknown",i="Unknown";if(e.status_entity_id&&this.hass?.states[e.status_entity_id]){const t=this.hass.states[e.status_entity_id].state;"on"===t?(o="online",i="Online"):"off"===t&&(o="offline",i="Offline")}else e.status&&(o="online"===e.status?"online":"offline"===e.status?"offline":"unknown",i="online"===e.status?"Online":"offline"===e.status?"Offline":"Unknown");const r="online"===o,s=this._getManagedDeviceKey(e,t),a=this._getDeviceEntities(e,t),n=(this._hiddenSensors[s]||[]).length,c="repeater"===t&&e.neighbors_enabled,d=this._neighborData[e.pubkey_prefix];return c&&!d&&this._loadNeighbors(e),j`
    ...
    `}_renderInlineNeighbors(e,t){return!t||t.loading?j`
      ...
      <div class="neighbor-section">
        ...
        <table class="neighbor-table">
          ...
          <tbody>
            ${t.neighbors.map(t=>j`
              <tr @contextmenu=${o=>this._onNeighborRightClick(o,t,e.pubkey_prefix)}
                ...
                <td class=${t.snr>5?"snr-good":t.snr>=0?"snr-fair":"snr-poor"}>
                  <span class="clickable-value"
                        @click=${o=>{o.stopPropagation(),this._openNeighborMoreInfo(e.pubkey_prefix,t.pubkey_prefix,"snr")}}>
                    ${t.snr.toFixed(1)} dB
                  </span>
                </td>
                <td>
                  <span class="clickable-value"
                        @click=${o=>{o.stopPropagation(),this._openNeighborMoreInfo(e.pubkey_prefix,t.pubkey_prefix,"seen")}}>
                    ${t.seen_48h??0}×
                  </span>
                </td>
    ...
    `}async _loadEntityRegistry(){if(this.hass&&!this._entityRegistryLoaded){this._entityRegistryLoaded=!0;try{const{meshcoreDeviceMap:e,deviceEntities:t}=await tt(this.hass);this._meshcoreDeviceMap=e,this._deviceEntities=t}catch(e){console.error("Failed to load entity registry:",e)}}}_getDeviceEntities(e,t){if(!this.hass||!this.config)return[];const o=this._getManagedDeviceKey(e,t),i=new Set(this._hiddenSensors[o]||[]),r=this.selectedDevice?.entry_id||"",s=e.pubkey_prefix||"",a=`${r}_${t}_${s}`,n=this._meshcoreDeviceMap[a];if(n&&this._deviceEntities[n])return this._deviceEntities[n].filter(e=>!i.has(e.entity_id));for(const[e,o]of Object.entries(this._meshcoreDeviceMap))if(e.includes(s)&&e.includes(t)&&this._deviceEntities[o])return this._deviceEntities[o].filter(e=>!i.has(e.entity_id));const c=s.substring(0,6).toLowerCase();if(!c)return[];const d=[];for(const e of Object.values(this._deviceEntities))for(const t of e)t.entity_id.toLowerCase().includes(c)&&!i.has(t.entity_id)&&d.push(t);return d.sort((e,t)=>e.sortOrder-t.sortOrder)}async _loadNeighbors(e){if(this.hass){this._neighborData={...this._neighborData,[e.pubkey_prefix]:{neighbors:[],chartData:[],loading:!0,loaded:!1}};try{const t=await async function(e,t,o){try{const i={type:"meshcore_chat/get_neighbors",target_prefix:t};return o&&(i.entry_id=o),(await e.callWS(i)).neighbors||[]}catch{return[]}}(this.hass,e.pubkey_prefix,this.config?.node_prefix);let o=[];t.length>0&&(o=await this._fetchSNRHistory(t)),this._neighborData={...this._neighborData,[e.pubkey_prefix]:{neighbors:t,chartData:o,loading:!1,loaded:!0}}}catch(t){console.error(`Failed to load neighbors for ${e.name}:`,t),this._neighborData={...this._neighborData,[e.pubkey_prefix]:{neighbors:[],chartData:[],loading:!1,loaded:!0}}}}}async _fetchSNRHistory(e){if(!this.hass)return[];try{const t=e.filter(e=>e.entity_ids?.snr).map(e=>e.entity_ids.snr);if(0===t.length)return[];const o=await this.hass.callWS({type:"recorder/statistics_during_period",start_time:new Date(Date.now()-864e5).toISOString(),end_time:(new Date).toISOString(),statistic_ids:t,period:"hour"}),i={};return Object.entries(o).forEach(([t,o])=>{const r=e.find(e=>e.entity_ids?.snr===t);r&&Array.isArray(o)&&o.forEach(e=>{if(e.start&&null!=e.mean){const t=new Date(e.start).getTime();i[t]||(i[t]={}),i[t][r.pubkey_prefix]=e.mean}})}),Object.entries(i).map(([e,t])=>({timestamp:parseInt(e,10),values:t})).sort((e,t)=>e.timestamp-t.timestamp)}catch{return[]}}async _loadManagedDevices(){if(this.hass)try{this._loading=!0,this._error=null;const e=await async function(e,t){try{const o={type:"meshcore_chat/get_managed_devices"};t&&(o.entry_id=t);const i=await e.callWS(o);return{repeaters:i.repeaters||[],clients:i.clients||[]}}catch{return{repeaters:[],clients:[]}}}(this.hass,this.config?.node_prefix);this._managedDevices=e}catch(e){this._error=`Failed to load devices: ${String(e)}`}finally{this._loading=!1}}async _executeRemoteAction(e,t){if(this.hass)try{const o=await Me(this.hass,e.pubkey_prefix,t,this.config?.node_prefix);this._showStatusMessage(`${e.name}: ${t} → ${o.response||"OK"}`,"success")}catch(o){this._showStatusMessage(`${e.name}: ${t} failed — ${String(o)}`,"error")}}_fireMoreInfo(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}_confirmActionDialog(e,t,o){this._confirmAction={title:e,message:t,onConfirm:o},this._confirmDialogOpen=!0}async _onConfirmAction(){if(this._confirmDialogOpen=!1,this._confirmAction)try{await this._confirmAction.onConfirm()}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}this._confirmAction=null}_onConfirmCancel(){this._confirmDialogOpen=!1,this._confirmAction=null}_openCommandDialog(e,t){this._commandDialogTarget=e.pubkey_prefix,this._commandDialogIsLocal=t,this._commandDialogOpen=!0}_onCommandDialogClose(){this._commandDialogOpen=!1,this._commandDialogTarget="",this._commandDialogIsLocal=!1}_getManagedDeviceKey(e,t){return`${this.selectedDevice?.entry_id||""}_${t}_${e.pubkey_prefix}`}_loadHiddenSensors(){try{const e=localStorage.getItem("meshcore-hidden-sensors");e&&(this._hiddenSensors=JSON.parse(e))}catch{this._hiddenSensors={}}}_saveHiddenSensors(){try{localStorage.setItem("meshcore-hidden-sensors",JSON.stringify(this._hiddenSensors))}catch{}}_hideSensor(e,t){const o=this._hiddenSensors[e]||[];o.includes(t)||(this._hiddenSensors={...this._hiddenSensors,[e]:[...o,t]},this._saveHiddenSensors())}_unhideSensor(e,t){const o=this._hiddenSensors[e]||[];if(this._hiddenSensors={...this._hiddenSensors,[e]:o.filter(e=>e!==t)},0===this._hiddenSensors[e].length){const t={...this._hiddenSensors};delete t[e],this._hiddenSensors=t}this._saveHiddenSensors()}_unhideAllSensors(e){const t={...this._hiddenSensors};delete t[e],this._hiddenSensors=t,this._saveHiddenSensors()}_onTileContextMenu(e,t){const{entityId:o,label:i}=e.detail;this._contextMenu={entityId:o,label:i,deviceKey:t},this._overlayPointerStarted=!1}_onOverlayPointerDown(){this._overlayPointerStarted=!0}_dismissContextMenu(){this._overlayPointerStarted=!1,this._contextMenu=null}_closeContextMenu(){this._overlayPointerStarted&&this._dismissContextMenu()}_hideSensorFromContext(){this._contextMenu&&(this._hideSensor(this._contextMenu.deviceKey,this._contextMenu.entityId),this._showStatusMessage(`Hidden: ${this._contextMenu.label}`,"success"),this._contextMenu=null)}_onNeighborRightClick(e,t,o){e.preventDefault(),this._neighborContextMenu={name:t.name||t.pubkey_prefix,neighborPubkey:t.pubkey_prefix,repeaterPubkey:o},this._overlayPointerStarted=!1}_dismissNeighborContextMenu(){this._overlayPointerStarted=!1,this._neighborContextMenu=null}_closeNeighborContextMenu(){this._overlayPointerStarted&&this._dismissNeighborContextMenu()}_removeNeighborFromContext(){if(!this._neighborContextMenu)return;const{name:e,neighborPubkey:t,repeaterPubkey:o}=this._neighborContextMenu;this._neighborContextMenu=null,this._confirmActionDialog(`Remove neighbor ${e}?`,"This will remove the neighbor from the repeater and delete its sensors from HA. This cannot be undone.",()=>this._executeRemoveNeighbor(o,t,e))}_openNeighborMoreInfo(e,t,o){const i=e.substring(0,10).toLowerCase(),r=t.substring(0,6).toLowerCase(),s="snr"===o?`sensor.meshcore_${i}_neighbor_${r}`:`sensor.meshcore_${i}_neighbor_${r}_seen`;this.hass?.states[s]&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:s},bubbles:!0,composed:!0}))}async _executeRemoveNeighbor(e,t,o){if(this.hass)try{const i=await this.hass.callWS({type:"meshcore_chat/remove_neighbor",entry_id:this.config?.node_prefix,target_prefix:e,neighbor_pubkey:t}),r=i?.entities_removed??0;this._showStatusMessage(`Removed ${o} (${r} sensors deleted)`,"success");const s=this._managedDevices.repeaters.find(t=>t.pubkey_prefix===e);s&&await this._loadNeighbors(s)}catch(e){this._showStatusMessage(`Failed to remove ${o}: ${e.message||e}`,"error")}}_getSettingsDeviceContext(){const e=this._settingsDeviceKey;if(!e)return null;const t=[...this._managedDevices.repeaters.map(e=>({device:e,type:"repeater"})),...this._managedDevices.clients.map(e=>({device:e,type:"client"}))];for(const{device:o,type:i}of t)if(this._getManagedDeviceKey(o,i)===e){let e=!1;return e=o.status_entity_id&&this.hass?.states[o.status_entity_id]?"on"===this.hass.states[o.status_entity_id].state:"online"===o.status,{device:o,type:i,name:o.name,isOnline:e}}return null}_closeSettingsModal(){this._settingsDeviceKey=null}_openHiddenSensorsList(){this._hiddenSensorsModalKey=this._settingsDeviceKey,this._settingsDeviceKey=null}_renderHiddenSensorsModal(){const e=this._hiddenSensorsModalKey,t=(this._hiddenSensors[e]||[]).map(e=>{let t=e;for(const o of Object.values(this._deviceEntities)){const i=o.find(t=>t.entity_id===e);if(i){t=i.label;break}}return{entityId:e,label:t}});return j`
    ...
    `],e([me({type:Object})],ot.prototype,"hass",void 0),e([me({type:Object})],ot.prototype,"config",void 0),e([me({type:Boolean})],ot.prototype,"narrow",void 0),e([me({type:Object})],ot.prototype,"selectedDevice",void 0),e([ue()],ot.prototype,"_managedDevices",void 0),e([ue()],ot.prototype,"_loading",void 0),e([ue()],ot.prototype,"_error",void 0),e([ue()],ot.prototype,"_confirmAction",void 0),e([ue()],ot.prototype,"_confirmDialogOpen",void 0),e([ue()],ot.prototype,"_commandDialogOpen",void 0),e([ue()],ot.prototype,"_commandDialogTarget",void 0),e([ue()],ot.prototype,"_commandDialogIsLocal",void 0),e([ue()],ot.prototype,"_statusMessage",void 0),e([ue()],ot.prototype,"_statusMessageTimeout",void 0),e([ue()],ot.prototype,"_deviceEntities",void 0),e([ue()],ot.prototype,"_meshcoreDeviceMap",void 0),e([ue()],ot.prototype,"_entityRegistryLoaded",void 0),e([ue()],ot.prototype,"_hiddenSensors",void 0),e([ue()],ot.prototype,"_contextMenu",void 0),e([ue()],ot.prototype,"_settingsDeviceKey",void 0),e([ue()],ot.prototype,"_hiddenSensorsModalKey",void 0),e([ue()],ot.prototype,"_neighborContextMenu",void 0),e([ue()],ot.prototype,"_neighborData",void 0),ot=e([pe("meshcore-devices-page")],ot);let it=class extends de{constructor(){super(...arguments),this.selected=!1}render(){if(!this.contact)return j``;const e=this.contact,t=this._getTypeClass(e.type),{label:o,cls:i}=this._getCategoryBadge(e);return j`
  ...
  `,e([me({type:Object})],it.prototype,"contact",void 0),e([me({type:Boolean})],it.prototype,"selected",void 0),it=e([pe("meshcore-contact-card")],it);let rt=class extends de{constructor(){super(...arguments),this.selected=!1}render(){if(!this.node)return j``;const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,o=e&&3===this.node.type,i=e?1===this.node.type:"client"===this.node.type,r=e&&4===this.node.type,s=e?this.node.adv_name:this.node.name,a=this.node.pubkey_prefix,n=e?this.node.last_advert:void 0;let c=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,d="Contact",l="";t?(c=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`,d="Repeater",l="repeater"):o?(c=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`,d="Room Server",l="room-server"):r?(c=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`,d="Sensor",l="sensor"):i&&(c=j`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`,d="Client",l="client");const p=e&&(0!==this.node.adv_lat||0!==this.node.adv_lon),h=n?new Date(1e3*n).toLocaleTimeString():"Unknown";return j`
  ...
  `,e([me({type:Object})],rt.prototype,"node",void 0),e([me({type:Boolean})],rt.prototype,"selected",void 0),rt=e([pe("meshcore-node-card")],rt);let st=class extends de{constructor(){super(...arguments),this.open=!1,this.pendingAction=null,this._confirming=!1,this._confirmAction=null}render(){if(!this.open||!this.node)return j``;const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,o=e&&3===this.node.type,i=e?1===this.node.type:"client"===this.node.type,r=e&&4===this.node.type,s=e?this.node.adv_name:this.node.name,a=this.node.pubkey_prefix;let n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,c="Contact",d="";return t?(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`,c="Repeater",d="repeater"):o?(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`,c="Room Server",d="room-server"):r?(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`,c="Sensor",d="sensor"):i&&(n=j`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`,c="Client",d="client"),j`
                ...
                `:j`
                  <div class="section">
                    ...
                    <div class="quick-actions ${e?"":"full"}">
                      ${e&&this.node.added_to_node&&(i||o)?j`
  ...
  `,e([me({type:Object})],st.prototype,"node",void 0),e([me({type:Boolean})],st.prototype,"open",void 0),e([me({type:Object})],st.prototype,"hass",void 0),e([me({type:String})],st.prototype,"pendingAction",void 0),e([ue()],st.prototype,"_confirming",void 0),e([ue()],st.prototype,"_confirmAction",void 0),st=e([pe("meshcore-node-detail-dialog")],st);const at={clients:1,repeaters:2,room_servers:3,sensors:4},nt={clients:"#4caf50",repeaters:"#ff9800",room_servers:"#9c27b0",sensors:"#607d8b"},ct={clients:"Clients",repeaters:"Repeaters",room_servers:"Room Servers",sensors:"Sensors"},dt={all:"",added:"#03a9f4",discovered:"#4caf50"};let lt=class extends de{constructor(){super(...arguments),this.contacts=[],this.channels=[],this.narrow=!1,this._viewportNarrow=!1,this._primaryFilter="all",this._typeFilter=null,this._searchQuery="",this._displayedContacts=[],this._totalCount=0,this._typeCounts={clients:0,repeaters:0,room_servers:0,sensors:0},this._l1Counts={all:0,added:0,discovered:0},this._loading=!1,this._nodeDetailDialogOpen=!1,this._pendingAction=null,this._sortBy="last_heard",this._onMediaChange=e=>{this._viewportNarrow=e.matches}}connectedCallback(){super.connectedCallback(),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaQuery.addEventListener("change",this._onMediaChange),this._loadCounts(),this._loadPage(!0)}disconnectedCallback(){super.disconnectedCallback(),this._mediaQuery?.removeEventListener("change",this._onMediaChange),this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=void 0)}get _isNarrow(){return this.narrow||this._viewportNarrow}updated(e){super.updated(e),this._isNarrow?this.setAttribute("narrow",""):this.removeAttribute("narrow")}render(){return j`
    ...
    `}_renderL1Button(e,t){const o=this._l1Counts[e],i=this._primaryFilter===e,r=dt[e];return j`
      <button
        class=${"l1-btn "+(i?"active":"")}
        style=${!i&&r?`border-left-color: ${r}`:""}
        @click=${()=>this._setPrimaryFilter(e)}>
        ${t} <span class="l1-count">(${o})</span>
      </button>
    `}_renderL2Buttons(){return["clients","repeaters","room_servers","sensors"].filter(e=>this._typeCounts[e]>0).map(e=>{const t=this._typeFilter===e,o=nt[e];return j`
          <button
            class=${"l2-btn "+(t?"active":"")}
            style=${t?`background: ${o}; border-color: ${o};`:`border-left: 2px solid ${o};`}
            @click=${()=>this._setTypeFilter(e)}>
            ${ct[e]} <span class="l2-count">(${this._typeCounts[e]})</span>
          </button>
        `})}_setPrimaryFilter(e){this._primaryFilter!==e&&(this._primaryFilter=e,this._typeFilter=null,this._displayedContacts=[],this._totalCount=0,this._loadPage(!0))}_setTypeFilter(e){this._typeFilter===e?this._typeFilter=null:this._typeFilter=e,this._displayedContacts=[],this._totalCount=0,this._loadPage(!0)}_onSearchInput(e){this._searchQuery=e.target.value,this._searchTimer&&clearTimeout(this._searchTimer),this._searchTimer=setTimeout(()=>this._loadPage(!0),300)}_getSearchPlaceholder(){const e=this._primaryFilter,t=this._typeFilter?ct[this._typeFilter].toLowerCase():"nodes";return"all"===e?"Search all nodes...":`Search ${e} ${t}...`}async _loadPage(e=!1){if(this.hass){this._loading=!0;try{const t=e?0:this._displayedContacts.length,o=this._typeFilter?at[this._typeFilter]:void 0,i=this._searchQuery.trim()||void 0,r=await async function(e,t="all",o={}){try{const i={type:"meshcore_chat/get_contacts_paginated",category:t,limit:o.limit??50,offset:o.offset??0};return void 0!==o.nodeType&&(i.node_type=o.nodeType),o.search&&(i.search=o.search),o.entryId&&(i.entry_id=o.entryId),o.sortBy&&(i.sort_by=o.sortBy),await e.callWS(i)}catch{return{contacts:[],total:0,counts:{clients:0,repeaters:0,room_servers:0,sensors:0}}}}(this.hass,this._primaryFilter,{nodeType:o,search:i,limit:50,offset:t,entryId:this.config?.entry_id,sortBy:this._sortBy});this._displayedContacts=e?r.contacts:[...this._displayedContacts,...r.contacts],this._totalCount=r.total,this._typeCounts=r.counts}catch(e){console.error("Failed to load contacts:",e)}finally{this._loading=!1}}}async _loadCounts(){if(this.hass)try{this._l1Counts=await async function(e,t){try{const o={type:"meshcore_chat/get_node_counts"};return t&&(o.entry_id=t),await e.callWS(o)}catch{return{all:0,added:0,discovered:0}}}(this.hass,this.config?.entry_id)}catch(e){console.error("Failed to load node counts:",e)}}async _clearStaleContacts(){if(!this.hass)return;const e=prompt("Remove discovered contacts older than how many days?","30");if(!e)return;const t=parseInt(e,10);isNaN(t)||t<1||t>365||(await async function(e,t,o){try{const i={type:"meshcore_chat/clear_discovered_contacts"};return void 0!==t&&(i.days_threshold=t),o&&(i.entry_id=o),await e.callWS(i)}catch{return{removed:0}}}(this.hass,t,this.config?.entry_id)).removed>0&&(this._loadPage(!0),this._loadCounts(),this.dispatchEvent(new CustomEvent("contacts-changed",{bubbles:!0,composed:!0})))}_syncAll(){this._loadPage(!0),this._loadCounts(),this.dispatchEvent(new CustomEvent("contacts-changed",{bubbles:!0,composed:!0}))}_renderContactsContent(){return this._loading&&0===this._displayedContacts.length?j`
        <div class="empty-state">
      ...
      `:W}
    `}_renderEmptyState(){const e=this._primaryFilter,t=this._typeFilter;let o=j`<svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor" opacity="0.5"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,i="No nodes found",r="";return this._searchQuery?(i="No matching nodes",r=`No results for "${this._searchQuery}"`):"added"===e?(i="No added contacts",r=t?`No added ${ct[t].toLowerCase()}`:"Add discovered contacts to see them here"):"discovered"===e?(i="No discovered nodes",r=t?`No discovered ${ct[t].toLowerCase()}`:"Nodes seen on the mesh will appear here"):"all"===e&&(i="No nodes",r="No contacts or discovered nodes yet"),j`
      <div class="empty-state">
        <div class="empty-icon">${o}</div>
        <div class="empty-text">${i}</div>
  ...
  `,e([me({type:Array})],lt.prototype,"contacts",void 0),e([me({type:Array})],lt.prototype,"channels",void 0),e([me({type:Boolean})],lt.prototype,"narrow",void 0),e([me({type:Object})],lt.prototype,"hass",void 0),e([me({type:Object})],lt.prototype,"config",void 0),e([ue()],lt.prototype,"_viewportNarrow",void 0),e([ue()],lt.prototype,"_primaryFilter",void 0),e([ue()],lt.prototype,"_typeFilter",void 0),e([ue()],lt.prototype,"_searchQuery",void 0),e([ue()],lt.prototype,"_displayedContacts",void 0),e([ue()],lt.prototype,"_totalCount",void 0),e([ue()],lt.prototype,"_typeCounts",void 0),e([ue()],lt.prototype,"_l1Counts",void 0),e([ue()],lt.prototype,"_loading",void 0),e([ue()],lt.prototype,"_selectedNode",void 0),e([ue()],lt.prototype,"_nodeDetailDialogOpen",void 0),e([ue()],lt.prototype,"_pendingAction",void 0),e([ue()],lt.prototype,"_sortBy",void 0),lt=e([pe("meshcore-nodes-page")],lt);let pt=class extends de{constructor(){super(...arguments),this.narrow=!1,this._deviceConfig=null,this._loading=!0,this._error=null,this._editValues={},this._saving=!1,this._commandDialogOpen=!1,this._confirmAction=null,this._confirmDialogOpen=!1,this._locationSource="manual",this._importKeyValue="",this._deviceEntities={},this._meshcoreDeviceMap={},this._entityRegistryLoaded=!1,this._hiddenSensors={},this._contextMenu=null,this._overlayPointerStarted=!1,this._settingsModalOpen=!1,this._keyManagementModalOpen=!1,this._hiddenSensorsModalKey=null,this._statusMessage=null,this._statusMessageTimeout=null,this._onCompanionTrace=()=>{const e=this.selectedDevice?.entry_id;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:e},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._loadDeviceConfig(),this._loadHiddenSensors()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadDeviceConfig(),e.has("hass")&&this.hass&&!this._entityRegistryLoaded&&this._loadEntityRegistry()}async _loadDeviceConfig(){if(this.hass){this._loading=!0,this._error=null;try{this._deviceConfig=await ke(this.hass,this.config?.node_prefix),this._deviceConfig?.location_source&&(this._locationSource=this._deviceConfig.location_source)}catch(e){this._error=`Failed to load device configuration: ${String(e)}`}finally{this._loading=!1}}}render(){return this._loading?j`
    ...
    `:j`<div>No device config loaded</div>`}_renderCompanionCard(){if(!this.selectedDevice)return W;const e=this.selectedDevice,t=e.connected,o=this._getCompanionDeviceKey(),i=this._getCompanionEntities(),r=(this._hiddenSensors[o]||[]).length;return j`
      <div class="device-section" @tile-context-menu=${e=>this._onTileContextMenu(e,o)}>
    ...
    `}_renderHiddenSensorsModal(){const e=this._hiddenSensorsModalKey,t=(this._hiddenSensors[e]||[]).map(e=>{let t=e;for(const o of Object.values(this._deviceEntities)){const i=o.find(t=>t.entity_id===e);if(i){t=i.label;break}}return{entityId:e,label:t}});return j`
      <div class="modal-overlay" @click=${this._closeHiddenSensorsModal}>
        <div class="modal-card" @click=${e=>e.stopPropagation()}>
          <div class="modal-header">
            <span class="modal-title">Hidden Sensors</span>
      ...
      <div class="section-row">
        ...
        <div class="form-group-inline">
          ...
          <select
            ...
            ${[[0,"0 - 1 byte"],[1,"1 - 2 byte"],[2,"2 - 3 byte"]].map(([e,t])=>{const o=this._editValues.path_hash_mode??this._deviceConfig.path_hash_mode??0;return j`<option value=${e} ?selected=${Number(o)===e}>${t}</option>`})}
          </select>
        </div>
      </div>
    ...
    `}_renderLocation(){if(!this._deviceConfig)return;const e="ha_location"===this._locationSource,t=e?this.hass?.states["zone.home"]:null,o=this._locationSource!==(this._deviceConfig.location_source??"manual"),i=this._hasChanges("location",["latitude","longitude"]),r=o||i,s=String(e&&t?t.attributes.latitude??0:this._editValues.latitude??this._deviceConfig.latitude??0),a=String(e&&t?t.attributes.longitude??0:this._editValues.longitude??this._deviceConfig.longitude??0);return j`
      <div class="section-row">
        <div class="form-group-inline">
    ...
    `}_hasChanges(e,t){return!!this._deviceConfig&&t.some(e=>void 0!==this._editValues[e]&&this._editValues[e]!==this._deviceConfig[e])}async _handleApply(e){if(!this.hass||!this._deviceConfig)return;let t=[];switch(e){case"device-name":t=["name"];break;case"radio-settings":t=["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode"]}const o={};for(const e of t)void 0!==this._editValues[e]&&(o[e]=this._editValues[e]);this._saving=!0;try{if((await Ce(this.hass,o,this.config?.node_prefix)).success){this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...o});for(const e of t)delete this._editValues[e];this._editValues={...this._editValues},this._showStatusMessage(`Saved: ${t.join(", ")}`,"success")}else this._showStatusMessage("Save failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}async _copyToClipboard(e){try{await navigator.clipboard.writeText(e),this._showStatusMessage("Copied to clipboard","success")}catch{this._showStatusMessage("Failed to copy","error")}}_showStatusMessage(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}_handleNameSave(){const e=this._editValues.name;void 0!==e&&e!==this._deviceConfig?.name&&(this._confirmAction={title:"Rename Device",message:"Changing the device name will change all entity IDs for this device. Any automations, scripts, or dashboards referencing current entity IDs will need to be updated. Continue?",onConfirm:async()=>{await this._handleApply("device-name")}},this._confirmDialogOpen=!0)}_handleRebootFromModal(){this._settingsModalOpen=!1,this._confirmAction={title:"Reboot Device",message:"Are you sure you want to reboot the device? The device will be temporarily unavailable.",onConfirm:()=>this._executeDeviceCommand("reboot")},this._confirmDialogOpen=!0}async _executeDeviceCommand(e){if(this.hass)try{const t=await Se(this.hass,e,void 0,this.config?.node_prefix);t.success?this._showStatusMessage(`Device ${e} initiated`,"success"):this._showStatusMessage(`Command failed: ${t.response}`,"error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}}async _applyLocation(){if(this.hass&&this._deviceConfig){this._saving=!0;try{const e=["latitude","longitude"],t={};if("ha_location"===this._locationSource){const e=this.hass.states["zone.home"];if(!e||null==e.attributes.latitude||null==e.attributes.longitude)return void this._showStatusMessage("Could not read zone.home coordinates from Home Assistant","error");t.latitude=e.attributes.latitude,t.longitude=e.attributes.longitude}else for(const o of e)void 0!==this._editValues[o]&&(t[o]=this._editValues[o]);if(Object.keys(t).length>0){if(!(await Ce(this.hass,t,this.config?.node_prefix)).success)return void this._showStatusMessage("Failed to save coordinates","error");this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...t});for(const t of e)delete this._editValues[t];this._editValues={...this._editValues}}if(!(await async function(e,t,o){try{const i={type:"meshcore_chat/set_location_source",source:t};return o&&(i.entry_id=o),await e.callWS(i)}catch{return{success:!1}}}(this.hass,this._locationSource,this.config?.node_prefix)).success)return void this._showStatusMessage("Failed to update location source","error");await this._loadDeviceConfig(),this._showStatusMessage("Location settings applied","success")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}}_showRegenIdentityConfirm(){this._confirmAction={title:"Regenerate Identity",message:"This will create a new cryptographic identity. All existing contacts will need to re-add your device. All entity IDs will change — automations, scripts, and dashboards using current entity IDs will need to be updated. This cannot be undone.",requireTyped:"REGENERATE",onConfirm:async()=>{if(!this.hass)return;const e=await async function(e,t){try{const o={type:"meshcore_chat/regenerate_identity"};return t&&(o.entry_id=t),await e.callWS(o)}catch{return{success:!1}}}(this.hass,this.config?.node_prefix);e.success?(this._showStatusMessage(`New identity created: ${e.new_pubkey?.slice(0,8)}...`,"success"),await this._loadDeviceConfig()):this._showStatusMessage("Identity regeneration failed","error")}},this._confirmDialogOpen=!0}_handleImportKeyConfirm(){this._importKeyValue.trim()&&(this._confirmAction={title:"Import Private Key",message:"Importing a private key changes the device identity. All entity IDs will change — automations, scripts, and dashboards using current entity IDs will need to be updated. A reboot is required after import.",onConfirm:()=>this._importIdentityKey()},this._confirmDialogOpen=!0)}async _importIdentityKey(){if(this.hass&&this._importKeyValue.trim())try{const e=await async function(e,t,o){try{const i={type:"meshcore_chat/import_identity",private_key:t};return o&&(i.entry_id=o),await e.callWS(i)}catch{return{success:!1}}}(this.hass,this._importKeyValue.trim(),this.config?.node_prefix);e.success?(this._importKeyValue="",this._showStatusMessage(`Identity imported: ${e.pubkey?.slice(0,8)}...`,"success"),await this._loadDeviceConfig()):this._showStatusMessage("Identity import failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}}async _onConfirmAction(){if(this._confirmDialogOpen=!1,this._confirmAction)try{await this._confirmAction.onConfirm()}catch(e){this._error=`Error: ${String(e)}`}this._confirmAction=null}_onConfirmCancel(){this._confirmDialogOpen=!1,this._confirmAction=null}_onCommandDialogClose(){this._commandDialogOpen=!1}async _loadEntityRegistry(){if(this.hass&&!this._entityRegistryLoaded){this._entityRegistryLoaded=!0;try{const{meshcoreDeviceMap:e,deviceEntities:t}=await tt(this.hass);this._meshcoreDeviceMap=e,this._deviceEntities=t}catch(e){console.error("Failed to load entity registry:",e)}}}_getCompanionEntities(){if(!this.hass||!this.selectedDevice)return[];const e=this._getCompanionDeviceKey(),t=new Set(this._hiddenSensors[e]||[]),o=this.selectedDevice.entry_id,i=this._meshcoreDeviceMap[o];if(i&&this._deviceEntities[i])return this._deviceEntities[i].filter(e=>!t.has(e.entity_id));const r=this.selectedDevice.pubkey_prefix?.substring(0,6)?.toLowerCase()||"";if(!r)return[];const s=[];for(const[e,o]of Object.entries(this._deviceEntities))if(!Object.entries(this._meshcoreDeviceMap).some(([t,o])=>o===e&&(t.includes("_repeater_")||t.includes("_client_"))))for(const e of o)e.entity_id.toLowerCase().includes(r)&&!t.has(e.entity_id)&&s.push(e);return s.sort((e,t)=>e.sortOrder-t.sortOrder)}_getCompanionDeviceKey(){return this.selectedDevice?.entry_id||"companion"}_loadHiddenSensors(){try{const e=localStorage.getItem("meshcore-hidden-sensors");e&&(this._hiddenSensors=JSON.parse(e))}catch{this._hiddenSensors={}}}_saveHiddenSensors(){try{localStorage.setItem("meshcore-hidden-sensors",JSON.stringify(this._hiddenSensors))}catch{}}_hideSensor(e,t){const o=this._hiddenSensors[e]||[];o.includes(t)||(this._hiddenSensors={...this._hiddenSensors,[e]:[...o,t]},this._saveHiddenSensors())}_unhideSensor(e,t){const o=this._hiddenSensors[e]||[];if(this._hiddenSensors={...this._hiddenSensors,[e]:o.filter(e=>e!==t)},0===this._hiddenSensors[e].length){const t={...this._hiddenSensors};delete t[e],this._hiddenSensors=t}this._saveHiddenSensors()}_unhideAllSensors(e){const t={...this._hiddenSensors};delete t[e],this._hiddenSensors=t,this._saveHiddenSensors()}async _executeCompanionAction(e,t,o){if(!this.hass)return;const i=o||e;try{const o=await Se(this.hass,e,t,this.config?.node_prefix);this._showStatusMessage(`Companion: ${i} → ${o.response||"OK"}`,"success")}catch(e){this._showStatusMessage(`Companion: ${i} failed — ${String(e)}`,"error")}}_onTileContextMenu(e,t){const{entityId:o,label:i}=e.detail;this._contextMenu={entityId:o,label:i,deviceKey:t},this._overlayPointerStarted=!1}_onOverlayPointerDown(){this._overlayPointerStarted=!0}_closeContextMenu(){this._overlayPointerStarted&&(this._overlayPointerStarted=!1,this._contextMenu=null)}_hideSensorFromContext(){this._contextMenu&&(this._hideSensor(this._contextMenu.deviceKey,this._contextMenu.entityId),this._showStatusMessage(`Hidden: ${this._contextMenu.label}`,"success"),this._contextMenu=null)}_closeSettingsModal(){this._settingsModalOpen=!1}_openHiddenSensorsList(){this._hiddenSensorsModalKey=this._getCompanionDeviceKey(),this._settingsModalOpen=!1}_closeHiddenSensorsModal(){this._hiddenSensorsModalKey=null}_openCommandDialogForCompanion(){this._commandDialogOpen=!0,this._settingsModalOpen=!1}_openKeyManagementModal(){this._keyManagementModalOpen=!0,this._settingsModalOpen=!1}_closeKeyManagementModal(){this._keyManagementModalOpen=!1}};pt.styles=[ve,a`
      :host {
        display: block;
        width: 100%;
        height: 100%;
    ...
    `}_renderRepeaterPicker(){const e=new Set(this.pathHops.map(e=>e.public_key)),t=this._repeaterFilter.trim().toLowerCase(),o=[...this.availableRepeaters].filter(t=>!e.has(t.public_key)).filter(e=>{if(!t)return!0;const o=(e.adv_name||"").toLowerCase(),i=(e.pubkey_prefix||"").toLowerCase();return o.includes(t)||i.startsWith(t)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||"")),i=this.targetContact?.adv_name||this.targetContact?.pubkey_prefix||"(no target)",r=this.targetContact?.pubkey_prefix?.substring(0,2).toUpperCase()||"--";return j`
      <div class="info-item">
        ...
        <div class="repeater-picker">
          <div class="picker-column">
            ...
            <div class="picker-list">
              ${0===o.length?j`<div class="picker-empty">${t?"No matches":"No repeaters available"}</div>`:o.map(e=>j`
                      <div
                        class="picker-item"
      ...
      <div class="info-item">
        ...
        <div class="target-row">
          <span class="target-name">${i}</span>
          <span class="target-hex">${r}</span>
        </div>
      </div>
    `}_renderExplicitInput(){const e=!!this.enteredPath&&!this._isValidExplicitHops(),t=this.targetContact?.adv_name||this.targetContact?.pubkey_prefix||"(no target)",o=this.targetContact?.pubkey_prefix?.substring(0,2).toUpperCase()||"--";return j`
      <div class="info-item">
      ...
      <div class="info-item">
        ...
        <div class="target-row">
          ...
          <span class="target-hex">${o}</span>
        </div>
      </div>
    `}_addRepeater(e){this.pathHops=[...this.pathHops,e]}_removeRepeater(e){this.pathHops=this.pathHops.filter((t,o)=>o!==e)}_moveRepeater(e,t){const o=e+t;if(o<0||o>=this.pathHops.length)return;const i=[...this.pathHops];[i[e],i[o]]=[i[o],i[e]],this.pathHops=i}_isValidExplicitHops(){const e=this.enteredPath.trim();if(!e)return!0;const t=e.split(",").map(e=>e.trim());if(0===t.length)return!1;const o=t[0].length;if(![2,4,8].includes(o))return!1;const i=/^[0-9a-fA-F]+$/;return t.every(e=>e.length===o&&i.test(e))}_canRunTrace(){return"discovery"===this.pathMode||("select"===this.pathMode?!!this.targetContact:"explicit"===this.pathMode&&!!this.targetContact&&this._isValidExplicitHops())}_buildPathString(){if("select"===this.pathMode){if(!this.targetContact)return"";const e=this.targetContact.pubkey_prefix.substring(0,2).toUpperCase(),t=this.pathHops.map(e=>e.pubkey_prefix.substring(0,2).toUpperCase());return 0===t.length?e:[...t,e,...[...t].reverse()].join(",")}if("explicit"===this.pathMode){if(!this.targetContact)return"";const e=this.targetContact.pubkey_prefix.substring(0,2).toUpperCase(),t=this.enteredPath.trim();if(!t)return e;const o=t.split(",").map(e=>e.trim().toUpperCase());return[...o,e,...[...o].reverse()].join(",")}return""}_renderResult(e){const t=(e.path||[]).filter(e=>e.hash);return j`
      <div class="info-item">
  ...
  `],e([me({type:Boolean})],ht.prototype,"open",void 0),e([me({type:String})],ht.prototype,"contactName",void 0),e([me({type:Object})],ht.prototype,"result",void 0),e([me({type:String})],ht.prototype,"error",void 0),e([me({type:Array})],ht.prototype,"availableRepeaters",void 0),e([me({type:Object})],ht.prototype,"targetContact",void 0),e([ue()],ht.prototype,"pathMode",void 0),e([ue()],ht.prototype,"pathHops",void 0),e([ue()],ht.prototype,"enteredPath",void 0),e([ue()],ht.prototype,"_repeaterFilter",void 0),e([ue()],ht.prototype,"_running",void 0),ht=e([pe("meshcore-trace-dialog")],ht);let gt=class extends de{constructor(){super(...arguments),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._boundKeydown=null,this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._boundKeydown=e=>{this.open&&"Escape"===e.key&&(e.stopPropagation(),this._close())},document.addEventListener("keydown",this._boundKeydown)}disconnectedCallback(){super.disconnectedCallback(),this._boundKeydown&&(document.removeEventListener("keydown",this._boundKeydown),this._boundKeydown=null)}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return j``;const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const o=(t.adv_name||"").toLowerCase(),i=(t.pubkey_prefix||"").toLowerCase();return o.includes(e)||i.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return j`
    ...
    `}_renderActivePage(){switch(this._activeTab){case"chat":return j`
          ...
          <meshcore-settings-page
            ...
            .selectedDevice=${this._selectedDevice}
            .narrow=${this.narrow}
            @companion-trace-requested=${this._onCompanionTraceRequested}></meshcore-settings-page>`}}_toggleMenu(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}_deviceEntitySuffix(e){return{prefix:(e.pubkey_prefix||e.pubkey||"").substring(0,6).toLowerCase(),name:(e.name||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,"")}}_getNodeStatus(e){if(!this.hass)return null;const{prefix:t,name:o}=this._deviceEntitySuffix(e),i=`sensor.meshcore_${t}_node_status_${o}`,r=this.hass.states[i];return r?r.state:null}_getBatteryLevel(e){if(!this.hass)return null;const{prefix:t,name:o}=this._deviceEntitySuffix(e),i=`sensor.meshcore_${t}_battery_percentage_${o}`,r=this.hass.states[i];if(!r||"unknown"===r.state||"unavailable"===r.state)return null;const s=parseFloat(r.state);return isNaN(s)?null:Math.round(s)}_onDeviceChange(e){const t=e.target;this._selectedEntryId=t.value||null,this._loadDeviceData()}async _loadData(){if(this.hass&&!this._loadingStarted){this._loadingStarted=!0,this._loading=!0,this._error=null;try{const e=await async function(e){try{return(await e.callWS({type:"meshcore_chat/get_devices"})).devices||[]}catch{return[]}}(this.hass);if(this._devices=e,0===e.length)return this._error="No MeshCore devices found",void(this._loading=!1);const t=e.find(e=>e.connected);this._selectedEntryId=(t||e[0]).entry_id;const o=t||e[0];this._config={node_name:o.name,node_prefix:o.pubkey_prefix?.substring(0,6)||"",entry_id:o.entry_id,..._e,...xe},await this._loadDeviceData(),await this._loadUnreadCounts()}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to load: ${t}`,console.error("MeshCore panel load error:",e)}finally{this._loading=!1}}}async _loadDeviceData(){if(this.hass&&this._selectedEntryId)try{const[e,t]=await Promise.all([we(this.hass,this._selectedEntryId),$e(this.hass,this._selectedEntryId)]);this._contacts=e,this._channels=t;const o=this._selectedDevice;o&&this._config&&(this._config={...this._config,node_name:o.name,node_prefix:o.pubkey_prefix?.substring(0,6)||"",entry_id:o.entry_id})}catch(e){console.error("Failed to load device data:",e)}}_onUnreadCleared(e){const{entityId:t}=e.detail;t&&this._unreadCounts[t]&&(this._unreadCounts={...this._unreadCounts,[t]:0})}_onActiveEntityChanged(e){this._activeChatEntityId=e.detail?.entityId||null}async _loadUnreadCounts(){if(this.hass)try{const e=await async function(e,t){try{const o={type:"meshcore_chat/get_unread_counts"};return t&&(o.entry_id=t),(await e.callWS(o)).unread||{}}catch{return{}}}(this.hass,this._selectedEntryId||void 0);this._activeChatEntityId&&e[this._activeChatEntityId]&&(e[this._activeChatEntityId]=0),this._unreadCounts=e}catch{}}async _handleNodeAction(e){const{action:t,node:o}=e.detail;if(!this.hass||!o)return;const i=o.public_key||"",r=o.pubkey_prefix||"",s=this._selectedEntryId||void 0;switch(t){case"message":r&&(this._pendingChatTarget=r,this._activeTab="chat");break;case"remove-contact":if(i)try{await Ae(this.hass,i,s),await this._loadDeviceData(),await this._refreshNodesPageAfterMutation(i)}finally{this._clearNodesPagePending()}break;case"add-contact":if(i)try{await ze(this.hass,i,o.adv_name||void 0,s),await this._loadDeviceData(),await this._refreshNodesPageAfterMutation(i)}finally{this._clearNodesPagePending()}break;case"trace":r&&(this._traceDialogPubkeyPrefix=r,this._traceDialogEntryId=s,this._traceDialogContactName=o.adv_name||r,this._traceDialogTargetContact="adv_name"in o?o:null,this._traceDialogResult=null,this._traceDialogError="",this._traceDialogOpen=!0);break;case"delete":case"remove":i&&(await Ae(this.hass,i,s),await this._loadDeviceData());break;default:console.warn("Unhandled node action:",t)}}async _refreshNodesPageAfterMutation(e){const t=this.shadowRoot?.querySelector("meshcore-nodes-page");if(t&&"function"==typeof t.refreshAfterMutation)try{await t.refreshAfterMutation(e)}catch(e){console.error("Failed to refresh nodes-page after mutation:",e)}}_clearNodesPagePending(){const e=this.shadowRoot?.querySelector("meshcore-nodes-page");e&&"function"==typeof e.clearPendingAction&&e.clearPendingAction()}};mt.styles=[ve,a`
      :host {
        display: block;
        width: 100%;
        height: 100vh;
